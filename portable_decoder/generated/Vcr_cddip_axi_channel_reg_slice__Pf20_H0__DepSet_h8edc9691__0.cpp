...
VL_INLINE_OPT void Vcr_cddip_axi_channel_reg_slice__Pf20_H0___nba_comb__TOP__cr_cddip__DOT__u_cr_xp10_decomp__DOT__xp10_decomp_rtl_start__DOT__u_cr_xp10_decomp_core__DOT__no_stub__DOT__hufd__DOT__sdd__DOT__u_ld__DOT__reg_slices__BRA__3__KET____DOT__u_reg_slice__0(Vcr_cddip_axi_channel_reg_slice__Pf20_H0* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vcr_cddip__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vcr_cddip_axi_channel_reg_slice__Pf20_H0___nba_comb__TOP__cr_cddip__DOT__u_cr_xp10_decomp__DOT__xp10_decomp_rtl_start__DOT__u_cr_xp10_decomp_core__DOT__no_stub__DOT__hufd__DOT__sdd__DOT__u_ld__DOT__reg_slices__BRA__3__KET____DOT__u_reg_slice__0\n"); );
    // Init
