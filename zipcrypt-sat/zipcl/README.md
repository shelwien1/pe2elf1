...
```
./zipcl g <archive> <model.cpp> <nunk> <k0> <k1> <k2> [nfiles] [usecheck] [reverse]
```
...
```sh
./zipcl g basis.pak model8.cpp          8  a3e30892 f9185194 eb474b09 2 1 0
./zipcl g basis.pak model16.cpp         16 a3e30892 f9185194 eb474b09 3 1 0
./zipcl g basis.pak model8_deflate.cpp  8  a3e30892 f9185194 eb474b09 6 0 0
