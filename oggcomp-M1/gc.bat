...
set gcc=C:\clangN10x\bin\clang++.exe -DBLR_VORBIS -Ivorbislib
...
rem %gcc% -s -std=c++23 -Ofast -O3 -fpermissive -Wno-format %arch% %incs% %opts% %defs% -static main.cpp -o rogg.exe 

rem %gcc% -s -std=c++23 -Ofast -O3 -fpermissive -Wno-format %arch% %incs% %opts% %defs% -static -D_USE_MATH_DEFINES tsv2wav.cpp C:\clangN10x\lib\clang\23\lib\windows\clang_rt.builtins-x86_64.lib -o tsv2wav.exe 

rem %gcc% -s -std=c++23 -Ofast -O3 -fpermissive -Wno-format %arch% %incs% %opts% %defs% -static -D_USE_MATH_DEFINES tsvsteg.cpp C:\clangN10x\lib\clang\23\lib\windows\clang_rt.builtins-x86_64.lib -o tsvsteg.exe 

rem %gcc% -s -std=c++23 -Ofast -O3 -fpermissive -Wno-format %arch% %incs% %opts% %defs% -static -D_USE_MATH_DEFINES tsvtrans.cpp -o tsvtrans.exe 

rem %gcc% -s -std=c++23 -Ofast -O3 -fpermissive -Wno-format %arch% %incs% %opts% %defs% -static -D_USE_MATH_DEFINES tsvcomp.cpp -o tsvcomp.exe 
