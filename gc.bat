...
%gcc% -s -std=c++23 -Ofast -O3 -fpermissive -Wno-format %arch% %incs% %opts% %defs% -static main.cpp -o rogg.exe 
...
%gcc% -s -std=c++23 -Ofast -O3 -fpermissive -Wno-format %arch% %incs% %opts% %defs% -static -D_USE_MATH_DEFINES tsvcomp.cpp -o tsvcomp.exe 
