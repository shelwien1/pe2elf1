...
set gcc=C:\clangM10x\bin\clang++.exe "-Daligned_alloc(x,y)=_aligned_malloc(y,x)"
...
%gcc% -s -std=c++23 -Ofast -fpermissive -Wno-format %arch% %incs% %opts% -static stegdict.cpp -o stegdict.exe
