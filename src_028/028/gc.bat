...
%gcc% -s -std=c++23 -Ofast -Wno-format %arch% %incs% %opts% -static dxt5comp.cpp -o dxt5comp.exe

%gcc% -s -std=c++23 -Ofast -Wno-format %arch% %incs% %opts% -static ddsdet.cpp -o ddsdet.exe
rem -o coder.exe
