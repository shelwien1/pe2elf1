...
static void usage( void ) {
  ...
  "            occurrence table as something nothing reads.  Needed when the\n"
  "            coder that handles out.bmp rewrites run-length structure, as\n"
  "            BMF does -- the countdown makes the ranks depend on where the\n"
  "            runs are cut.  A mismatch is refused, never mis-decoded.\n"
  "  out.bmp   the index image: every pixel replaced by its palette index,\n"
