...
submatch insn {
  ...
  0x0f 0x38 0x17 11 ggg rrr [$pp==1] => "ptest " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x17 @addr      [$pp==1] => "ptest " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x29 11 ggg rrr [$pp==1] => "pcmpeqq " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x29 @addr      [$pp==1] => "pcmpeqq " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x30 11 ggg rrr [$pp==1] => "pmovzxbw " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x30 @addr      [$pp==1] => "pmovzxbw " ssereg[8+$g] "," $addr ;
  0x0f 0x3a 0x0b 11 ggg rrr @imm8 [$pp==1] => "roundsd " ssereg[8+$g] "," ssereg[8+$r] "," hex($imm8) ;
  0x0f 0x3a 0x0b @addr      @imm8 [$pp==1] => "roundsd " ssereg[8+$g] "," $addr "," hex($imm8) ;
  ...
  0x0f 0x38 0x10 11 ggg rrr [$pp==1] => "pblendvb " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x10 @addr      [$pp==1] => "pblendvb " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x14 11 ggg rrr [$pp==1] => "blendvps " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x14 @addr      [$pp==1] => "blendvps " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x15 11 ggg rrr [$pp==1] => "blendvpd " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x15 @addr      [$pp==1] => "blendvpd " ssereg[8+$g] "," $addr ;
  ...
  0x0f 0x38 0x20 11 ggg rrr [$pp==1] => "pmovsxbw " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x20 @addr      [$pp==1] => "pmovsxbw " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x21 11 ggg rrr [$pp==1] => "pmovsxbd " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x21 @addr      [$pp==1] => "pmovsxbd " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x22 11 ggg rrr [$pp==1] => "pmovsxbq " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x22 @addr      [$pp==1] => "pmovsxbq " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x23 11 ggg rrr [$pp==1] => "pmovsxwd " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x23 @addr      [$pp==1] => "pmovsxwd " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x24 11 ggg rrr [$pp==1] => "pmovsxwq " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x24 @addr      [$pp==1] => "pmovsxwq " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x25 11 ggg rrr [$pp==1] => "pmovsxdq " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x25 @addr      [$pp==1] => "pmovsxdq " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x28 11 ggg rrr [$pp==1] => "pmuldq " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x28 @addr      [$pp==1] => "pmuldq " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x2a @addr      => "movntdqa " ssereg[$opsiz*8+$g] "," $addr ;
  0x0f 0x38 0x2b 11 ggg rrr [$pp==1] => "packusdw " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x2b @addr      [$pp==1] => "packusdw " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x31 11 ggg rrr [$pp==1] => "pmovzxbd " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x31 @addr      [$pp==1] => "pmovzxbd " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x32 11 ggg rrr [$pp==1] => "pmovzxbq " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x32 @addr      [$pp==1] => "pmovzxbq " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x33 11 ggg rrr [$pp==1] => "pmovzxwd " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x33 @addr      [$pp==1] => "pmovzxwd " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x34 11 ggg rrr [$pp==1] => "pmovzxwq " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x34 @addr      [$pp==1] => "pmovzxwq " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x35 11 ggg rrr [$pp==1] => "pmovzxdq " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x35 @addr      [$pp==1] => "pmovzxdq " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x37 11 ggg rrr [$pp==1] => "pcmpgtq " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x37 @addr      [$pp==1] => "pcmpgtq " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x38 11 ggg rrr [$pp==1] => "pminsb " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x38 @addr      [$pp==1] => "pminsb " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x39 11 ggg rrr [$pp==1] => "pminsd " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x39 @addr      [$pp==1] => "pminsd " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x3a 11 ggg rrr [$pp==1] => "pminuw " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x3a @addr      [$pp==1] => "pminuw " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x3b 11 ggg rrr [$pp==1] => "pminud " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x3b @addr      [$pp==1] => "pminud " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x3c 11 ggg rrr [$pp==1] => "pmaxsb " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x3c @addr      [$pp==1] => "pmaxsb " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x3d 11 ggg rrr [$pp==1] => "pmaxsd " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x3d @addr      [$pp==1] => "pmaxsd " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x3e 11 ggg rrr [$pp==1] => "pmaxuw " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x3e @addr      [$pp==1] => "pmaxuw " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x3f 11 ggg rrr [$pp==1] => "pmaxud " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x3f @addr      [$pp==1] => "pmaxud " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x40 11 ggg rrr [$pp==1] => "pmulld " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x40 @addr      [$pp==1] => "pmulld " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0x41 11 ggg rrr [$pp==1] => "phminposuw " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0x41 @addr      [$pp==1] => "phminposuw " ssereg[8+$g] "," $addr ;
  0x0f 0x38 0xdb 11 ggg rrr [$pp==1] => "aesimc " ssereg[8+$g] "," ssereg[8+$r] ;
  0x0f 0x38 0xdb @addr      [$pp==1] => "aesimc " ssereg[8+$g] "," $addr ;
  ...
  0x0f 0x3a 0x08 11 ggg rrr @imm8 [$pp==1] => "roundps " ssereg[8+$g] "," ssereg[8+$r] "," hex($imm8) ;
  0x0f 0x3a 0x08 @addr      @imm8 [$pp==1] => "roundps " ssereg[8+$g] "," $addr "," hex($imm8) ;
  0x0f 0x3a 0x09 11 ggg rrr @imm8 [$pp==1] => "roundpd " ssereg[8+$g] "," ssereg[8+$r] "," hex($imm8) ;
  0x0f 0x3a 0x09 @addr      @imm8 [$pp==1] => "roundpd " ssereg[8+$g] "," $addr "," hex($imm8) ;
  0x0f 0x3a 0x0a 11 ggg rrr @imm8 [$pp==1] => "roundss " ssereg[8+$g] "," ssereg[8+$r] "," hex($imm8) ;
  0x0f 0x3a 0x0a @addr      @imm8 [$pp==1] => "roundss " ssereg[8+$g] "," $addr "," hex($imm8) ;
  0x0f 0x3a 0x0c 11 ggg rrr @imm8 [$pp==1] => "blendps " ssereg[8+$g] "," ssereg[8+$r] "," hex($imm8) ;
  0x0f 0x3a 0x0c @addr      @imm8 [$pp==1] => "blendps " ssereg[8+$g] "," $addr "," hex($imm8) ;
  0x0f 0x3a 0x0d 11 ggg rrr @imm8 [$pp==1] => "blendpd " ssereg[8+$g] "," ssereg[8+$r] "," hex($imm8) ;
  ...
  0x0f 0x3a 0x22 11 ggg rrr @imm8 [$pp==1] => "pinsrd " ssereg[8+$g] "," gregd[$r] "," hex($imm8) ;
  0x0f 0x3a 0x22 @addr      @imm8 [$pp==1] => "pinsrd " ssereg[8+$g] "," $addr "," hex($imm8) ;
  0x0f 0x3a 0x40 11 ggg rrr @imm8 [$pp==1] => "dpps " ssereg[8+$g] "," ssereg[8+$r] "," hex($imm8) ;
  0x0f 0x3a 0x40 @addr      @imm8 [$pp==1] => "dpps " ssereg[8+$g] "," $addr "," hex($imm8) ;
  0x0f 0x3a 0x41 11 ggg rrr @imm8 [$pp==1] => "dppd " ssereg[8+$g] "," ssereg[8+$r] "," hex($imm8) ;
  0x0f 0x3a 0x41 @addr      @imm8 [$pp==1] => "dppd " ssereg[8+$g] "," $addr "," hex($imm8) ;
  0x0f 0x3a 0x42 11 ggg rrr @imm8 [$pp==1] => "mpsadbw " ssereg[8+$g] "," ssereg[8+$r] "," hex($imm8) ;
  0x0f 0x3a 0x42 @addr      @imm8 [$pp==1] => "mpsadbw " ssereg[8+$g] "," $addr "," hex($imm8) ;
  0x0f 0x3a 0x44 11 ggg rrr @imm8 [$pp==1] => "pclmulqdq " ssereg[8+$g] "," ssereg[8+$r] "," hex($imm8) ;
  0x0f 0x3a 0x44 @addr      @imm8 [$pp==1] => "pclmulqdq " ssereg[8+$g] "," $addr "," hex($imm8) ;
  ...
  0x0f 0x3a 0x60 11 ggg rrr @imm8 [$pp==1] => "pcmpestrm " ssereg[8+$g] "," ssereg[8+$r] "," hex($imm8) ;
  0x0f 0x3a 0x60 @addr      @imm8 [$pp==1] => "pcmpestrm " ssereg[8+$g] "," $addr "," hex($imm8) ;
  0x0f 0x3a 0x61 11 ggg rrr @imm8 [$pp==1] => "pcmpestri " ssereg[8+$g] "," ssereg[8+$r] "," hex($imm8) ;
  0x0f 0x3a 0x61 @addr      @imm8 [$pp==1] => "pcmpestri " ssereg[8+$g] "," $addr "," hex($imm8) ;
  0x0f 0x3a 0x62 11 ggg rrr @imm8 [$pp==1] => "pcmpistrm " ssereg[8+$g] "," ssereg[8+$r] "," hex($imm8) ;
  0x0f 0x3a 0x62 @addr      @imm8 [$pp==1] => "pcmpistrm " ssereg[8+$g] "," $addr "," hex($imm8) ;
  0x0f 0x3a 0x63 11 ggg rrr @imm8 [$pp==1] => "pcmpistri " ssereg[8+$g] "," ssereg[8+$r] "," hex($imm8) ;
  0x0f 0x3a 0x63 @addr      @imm8 [$pp==1] => "pcmpistri " ssereg[8+$g] "," $addr "," hex($imm8) ;
...
submatch vex {
  ...
  # F16C vcvtps2ph (0F3A 1D, MRI store: dst=half-width r/m, src=full reg, imm8).
  h k b 00011 0 1111 y 01 0x1d 11 ggg rrr @imm8 => "vcvtps2ph " vreg[8*$b+$r] "," vreg[16*$y+8*$h+$g] "," hex($imm8) ;
  h k b 00011 0 1111 y 01 0x1d @addr {$rexb=1-$b;$rexx=1-$k} @imm8 => "vcvtps2ph " $addr "," vreg[16*$y+8*$h+$g] "," hex($imm8) ;
  # AVX-IFMA (VEX): vpmadd52luq/huq (0F38 B4/B5 W1, RVM).
  h k b 00010 1 vvvv y 01 0xb4 11 ggg rrr => "vpmadd52luq " vreg[16*$y+8*$h+$g] "," vvv[16*$y+$v] "," vreg[16*$y+8*$b+$r] ;
  h k b 00010 1 vvvv y 01 0xb4 @addr {$rexb=1-$b;$rexx=1-$k} => "vpmadd52luq " vreg[16*$y+8*$h+$g] "," vvv[16*$y+$v] "," $addr ;
  h k b 00010 1 vvvv y 01 0xb5 11 ggg rrr => "vpmadd52huq " vreg[16*$y+8*$h+$g] "," vvv[16*$y+$v] "," vreg[16*$y+8*$b+$r] ;
  h k b 00010 1 vvvv y 01 0xb5 @addr {$rexb=1-$b;$rexx=1-$k} => "vpmadd52huq " vreg[16*$y+8*$h+$g] "," vvv[16*$y+$v] "," $addr ;
  # AVX-VNNI-INT16 (VEX 66.0F38.W0 D2/D3, RVM): vpdpwusd / vpdpwusds.
  h k b 00010 0 vvvv y 01 0xd2 11 ggg rrr => "vpdpwusd " vreg[16*$y+8*$h+$g] "," vvv[16*$y+$v] "," vreg[16*$y+8*$b+$r] ;
  h k b 00010 0 vvvv y 01 0xd2 @addr {$rexb=1-$b;$rexx=1-$k} => "vpdpwusd " vreg[16*$y+8*$h+$g] "," vvv[16*$y+$v] "," $addr ;
  h k b 00010 0 vvvv y 01 0xd3 11 ggg rrr => "vpdpwusds " vreg[16*$y+8*$h+$g] "," vvv[16*$y+$v] "," vreg[16*$y+8*$b+$r] ;
  h k b 00010 0 vvvv y 01 0xd3 @addr {$rexb=1-$b;$rexx=1-$k} => "vpdpwusds " vreg[16*$y+8*$h+$g] "," vvv[16*$y+$v] "," $addr ;
  # GFNI (VEX): vgf2p8affineqb/invqb (0F3A CE/CF W1, RVMI).
  h k b 00011 1 vvvv y 01 0xce 11 ggg rrr @imm8 => "vgf2p8affineqb " vreg[16*$y+8*$h+$g] "," vvv[16*$y+$v] "," vreg[16*$y+8*$b+$r] "," hex($imm8) ;
  h k b 00011 1 vvvv y 01 0xce @addr {$rexb=1-$b;$rexx=1-$k} @imm8 => "vgf2p8affineqb " vreg[16*$y+8*$h+$g] "," vvv[16*$y+$v] "," $addr "," hex($imm8) ;
  h k b 00011 1 vvvv y 01 0xcf 11 ggg rrr @imm8 => "vgf2p8affineinvqb " vreg[16*$y+8*$h+$g] "," vvv[16*$y+$v] "," vreg[16*$y+8*$b+$r] "," hex($imm8) ;
  h k b 00011 1 vvvv y 01 0xcf @addr {$rexb=1-$b;$rexx=1-$k} @imm8 => "vgf2p8affineinvqb " vreg[16*$y+8*$h+$g] "," vvv[16*$y+$v] "," $addr "," hex($imm8) ;
...
submatch evex {
  ...
  # EVEX vprold/vprolq (0F72 group /1, rotate left) -- mirror of /0 vprord/vprorq
  h k b e 00 01 0 vvvv 1 01 z ll 0 u aaa 0x72 11 001 rrr @imm8 => wit("evex") "vprold " evvv[32*$l+16*$u+$v] kzdec[$z*8+$a] "," ereg[32*$l+16*$k+8*$b+$r] "," hex($imm8) ;
  h k b e 00 01 0 vvvv 1 01 z ll 0 u aaa 0x72 @addr(1) {$rexb=1-$b;$rexx=1-$k} @imm8 => wit("evex") "vprold " evvv[32*$l+16*$u+$v] kzdec[$z*8+$a] "," $addr "," hex($imm8) ;
  h k b e 00 01 0 vvvv 1 01 z ll 1 u aaa 0x72 @addr(1) {$rexb=1-$b;$rexx=1-$k} @imm8 => wit("evex") "vprold " evvv[32*$l+16*$u+$v] kzdec[$z*8+$a] "," $addr bcst32[$l] "," hex($imm8) ;
  h k b e 00 01 1 vvvv 1 01 z ll 0 u aaa 0x72 11 001 rrr @imm8 => wit("evex") "vprolq " evvv[32*$l+16*$u+$v] kzdec[$z*8+$a] "," ereg[32*$l+16*$k+8*$b+$r] "," hex($imm8) ;
  h k b e 00 01 1 vvvv 1 01 z ll 0 u aaa 0x72 @addr(1) {$rexb=1-$b;$rexx=1-$k} @imm8 => wit("evex") "vprolq " evvv[32*$l+16*$u+$v] kzdec[$z*8+$a] "," $addr "," hex($imm8) ;
  h k b e 00 01 1 vvvv 1 01 z ll 1 u aaa 0x72 @addr(1) {$rexb=1-$b;$rexx=1-$k} @imm8 => wit("evex") "vprolq " evvv[32*$l+16*$u+$v] kzdec[$z*8+$a] "," $addr bcst64[$l] "," hex($imm8) ;
