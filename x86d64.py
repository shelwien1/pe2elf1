#!/usr/bin/env python3
# Auto-generated standalone disassembler (parsergen.py --emit).
# Embeds the engine + the bit-pattern description; run: x86d.py IMAGE.bin
#!/usr/bin/env python3
...
# ============================ EVEX (0x62) ==================================
# P0 = R-bar X-bar B-bar R-bar' 0 0 mm   P1 = W vvvv 1 pp   P2 = z L'L b V-bar' aaa
# (h=R-bar k=X-bar b=B-bar e=R-bar' ; w=W v=vvvv p=pp ; z ll c=b-bit u=V-bar' a=aaa)
submatch evex {
...
def main(argv):
  ...
  if not argv:
    sys.stderr.write('usage: x86d.py IMAGE.bin\n'); return 2
