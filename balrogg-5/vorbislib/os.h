...
/* both GCC and MSVC are kinda stupid about rounding/casting to int.
   ...
   is collectively a noop), we do it v_this way */

/* we must set up the fpu before v_this works!! */
...
/* We don't have special code for v_this compiler/arch, so do it the slow way */
