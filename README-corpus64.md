...
`corpus64.p` (1360 lines, ~1100 rules, 80 tables, 188 mnemonics) covers the
classic x86-64 integer/FP ISA plus AVX/AVX2:
...
SIB); the EVEX forms of the width-changing converts; and the long tail of
rarer EVEX leaves. EVEX
