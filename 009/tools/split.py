...
LAYOUT = [
 ...
 ('decls.inc',      []),                           # generated
 ('sym_list.inc',    ['FreqRec', 'SymEntry', 'SymList', 'SymList::rescale',
 ...
 ('bitctr.inc',     ['SymPair', 'FreqPair', 'bit_tree', 'BitCtr', 'BitCtr::encode_context_bit',
                     ...
                     'CounterNode', 'init_counter_node']),
 ('alt_p1_block.inc',      ['CtxWeight', 'P1Ctx', 'AltP1Block', 'AltP1Block::ctx_of',
 ...
 ('bmp.inc',        ['BmfImage', 'BmpHeader', 'bmf_pixels', 'alloc_image']),
 ('file.inc',        ['BmfArc', 'BmfArc::bmf_close_archive', '__bmf_open_archive',
                     '__bmf_destroy_archive', 'bytes_left']),
 # the range coder's file-level ends, which are not the coder itself
 ('rc_io.inc',       ['rc_decode_flat', 'rc_end_decode', 'rc_end_encode',
                     'rc_begin_encode', 'rc_begin_decode', 'packer_word']),
 ('sym_code.inc',    ['encode_symbol_tree', 'decode_symbol_tree', 'alt_p1_encode_symbol',
                     'alt_p1_decode_symbol', 'update_binary_pair', 'estimate_cost']),
 ('sym_list_decode.inc', ['decode_symbol_list']),
 ('model_workspace.inc',  ['__free_workspace', '__layout_workspace']),
 ('sym_reduce.inc',    ['reduce_alphabet']),
 ('alt_p1.inc',         ['alt_init_tables', 'alt_model_p1_d8_encode', 'alt_model_p1_d8_decode']),
 ('alt_model_p1_encode.inc', ['alt_model_p1_encode']),
 ('alt_model_p1_decode.inc', ['alt_model_p1_decode']),
 ('alt_p2.inc',         ['__alt_p2_filter', '__alt_p2_d8_decode_body', '__alt_p2_d8_encode_body',
                     'alt_model_p2_d8_encode', 'alt_model_p2_d8_decode']),
 ('alt_p2_context.inc',      ['__alt_p2_context']),
 ('alt_p2_model.inc',        ['__alt_p2_model']),
 ('alt_p2_encode.inc', ['alt_model_p2_encode']),
 ('alt_p2_decode.inc', ['alt_model_p2_decode']),
 ('plane_predict.inc',    ['predict_med', 'unpredict_med', 'colour_transform',
                     'interleave_plane', 'transform_planes', 'expand_predictor_mode0']),
 ('plane.inc',      ['model_planes', 'unmodel_plane']),
 ('model_plane.inc',         ['model_plane']),
 ('filter_cost.inc',      ['cost_candidate']),
 ('plane_choose.inc', ['choose_plane_coding']),
 ('filter_search.inc',       ['search_filter']),
 ('bmp_read.inc',            ['read_bmp']),
 ('bmp_write.inc',           ['write_bmp']),
 ('image_expand.inc',        ['expand_image']),
 ('image_compress.inc',      ['compress_image']),
]

# What stays in bmf.cpp: the entry points.
KEEP = ['bmf_compress', 'bmf_decompress', '__main', 'main']
...
WHAT = {
 ...
 'alt_p1_block.inc': 'the alternate model for one-bit planes',
 ...
 'alt_p2_encode.inc': 'deep planes, encoded',
 'alt_p2_decode.inc': 'deep planes, decoded',
 ...
 'image_expand.inc': 'one member out of an archive',
