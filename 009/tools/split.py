...
LAYOUT = [
 ...
 ('sym_code.inc',    ['__encode_symbol_tree', '__decode_symbol_tree', '__alt_p1_encode_symbol',
                     '__alt_p1_decode_symbol', '__update_binary_pair', '__estimate_cost']),
 ('sym_list_decode.inc', ['__decode_symbol_list']),
 ('model_workspace.inc',  ['__free_workspace', '__layout_workspace']),
 ('sym_reduce.inc',    ['__reduce_alphabet']),
 ('alt_p1.inc',         ['__alt_init_tables', '__alt_model_p1_d8_encode', '__alt_model_p1_d8_decode']),
 ...
 ('alt_p2_encode.inc', ['__alt_model_p2_encode']),
 ('alt_p2_decode.inc', ['__alt_model_p2_decode']),
 ('plane_predict.inc',    ['__predict_med', '__unpredict_med', '__colour_transform',
 ...
 ('filter_cost.inc',      ['__cost_candidate']),
 ('plane_choose.inc', ['__choose_plane_coding']),
 ('filter_search.inc',       ['__search_filter']),
 ('bmp_read.inc',            ['__read_bmp']),
 ('bmp_write.inc',           ['__write_bmp']),
 ('image_expand.inc',        ['__expand_image']),
 ('image_compress.inc',      ['__compress_image']),
]
