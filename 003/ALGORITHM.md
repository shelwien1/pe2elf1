...
* **The `-S` context construction in detail.** §7.2 gives the shape — 15 groups,
  ...
  over two of those flags. `algorithm_v2.md` §8.2.1 has the table. `code_pixel` is 770 lines and would need a full reading.
* **The alternate model families.** When descriptor `+2` bit 2 is set,
  ...
  do; `alt_p2_model` (1422 lines here) sits under two of them.
