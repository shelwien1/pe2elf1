...
int32_t __alt_p2_context(AltP2Block *blk, AltP2Block *refa, AltP2Block *refb) {   P2Ctx *unused_p,
  ...
  int32_t *up_row;
  int32_t sum4, lane5, v19, v21, nb_id, next_id, plane, v68, v74, v75, v85,
          in63, *cur, c_lo, n2, c_mid, n3536_5, lane3, v112, v113, v114, v116,
          g3sum, n3536_1, v121, v122, lane2, v124, ctx0, bank0, pred0, sum_c,
          n2256, v132, v134, ctx1, bank1, w1c, one1, pred1, n2576, n1840_13,
          v147, v148, v149, v151, ctx2, bank2, pred2, n2896, v161, v162, v163,
          v164, bank3, w3c, pred3, n3536_2, v175, v176, v177, v178, v179,
          v181, v182, n3536_3, v185, v186, v188, v189, v190, v191, v192, v193,
          n1840_14, n1840_15, v198, n1840_16, v200, n1840_17, v203, v206,
          v207, v208, n960, n3536_4, mag, v212, v213, v214, v215, n1840_3,
          n1840_8, n1840_7, n1840_10, n1840_9, v222, v224, n1840_11, n1840_12,
          n255, v228, n1840_5, n1840_4, n1840_6, v234, v235, v236, v237, v238,
          v239, v240, v241, v242;
  int8_t rate1;
  ...
  den_d = 2 * row0[-2].lane[0] + 2 * v21;
  num_b = v19 + (cursor1->lane[0] + 2 * v21);
  num_d = 16 * (sub0_row[2].lane[0] + sub0_row->lane[0]
              + v19 + sub0_row[-1].lane[0]);
  ...
  blk->p2_row[0][0] = (float)nb1->lane[1];
  nb0 = (P2Ctx *)blk->cursor[0];
  blk->p2_row[0][1] = (float)nb1[1].lane[1];
  blk->p2_row[0][2] = (float)(nb0[-1].lane[1] + nb1->lane[1] - nb1[-1].lane[1]);
  row2c = (P2Ctx *)blk->cursor[2];
  blk->p2_row[0][3] = (float)(nb0[-2].lane[1] + (nb1->lane[1] - nb1[-2].lane[1]));
  nb3 = (P2Ctx *)blk->cursor[3];
  blk->p2_row[1][0] = (float)(nb1[-1].lane[1] + nb1->lane[1] - row2c[-1].lane[1]);
  blk->p2_row[1][1] = (float)(-3 * (row2c->lane[1] - nb1->lane[1]) + nb3->lane[1]);
  blk->p2_row[1][2] = (float)(nb0[-1].lane[1] + nb1[2].lane[1] - nb1[1].lane[1]);
  blk->p2_row[1][3] = (float)(nb0[-2].lane[1] + nb1[1].lane[1] - nb1[-1].lane[1]);
  blk->p2_row[2][0] = (float)(2 * nb0[-1].lane[1] - nb0[-2].lane[1]);
  nb2 = (P2Ctx *)(row2c);
  blk->p2_row[2][1] = (float)(nb0[-3].lane[1] + nb1->lane[1] - nb1[-3].lane[1]);
  blk->p2_row[2][2] = (float)(nb2->lane[1] + nb1[1].lane[1] - nb3[1].lane[1]);
  blk->p2_row[2][3] = (float)nb0[-3].lane[1];
  blk->p2_row[3][0] = (float)(nb1[-2].lane[1] + nb1->lane[1] - nb2[-2].lane[1]);
  blk->p2_row[3][1] = (float)(nb0[-2].lane[1] + nb1[-1].lane[1] - nb1[-3].lane[1]);
  blk->p2_row[3][2] = (float)(nb1[1].lane[1] + ((nb1[2].lane[1] + nb1->lane[1]) >> 1) - nb2[2].lane[1]);
  blk->p2_row[3][3] = (float)nb3->lane[1];
  if ( refa )
  {
    ...
    if ( plane )
    {
      if ( plane == 1 )
      {
        blk->p2_row[4][0] = (float)(nb0->lane[1] + nb1[3].lane[1]);
        blk->p2_row[4][1] = (float)(nb0[-2].lane[0] + ra1[2].lane[0] - ra1->lane[0]);
        blk->p2_row[4][2] = (float)(nb1[1].lane[0] + ra0[-1].lane[0] - ra1->lane[0]);
        blk->p2_row[4][3] = (float)(nb0[-1].lane[0] + ra1->lane[0] - ra1[-1].lane[0]);
        v85 = rb1[2].lane[0] - ((P2Ctx *)(rb2))[3].lane[0];
        blk->p2_row[5][0] = (float)(nb1[1].lane[0] + v85);
        blk->p2_row[5][1] = (float)(nb0[-2].lane[0] + rb0->lane[0] - rb0[-2].lane[0]);
        blk->p2_row[5][2] = (float)(nb1->lane[0] + rb0->lane[0] - rb1->lane[0]);
        no_ref = blk->has_ref == 0;
        blk->p2_row[5][3] = (float)(nb0[-2].lane[0] + ra0->lane[2]);
        if ( no_ref )
        {
          row0_i = (int32_t)(uintptr_t)nb0;
          nb2w = (int16_t *)blk->cursor[2];
          blk->p2_row[6][0] = ((float)(nb0[-2].lane[0] + ra0->lane[0] - ra0[-2].lane[0]));
          blk->p2_row[6][1] = (float)(*nb2w + ra0->lane[0] - ((P2Ctx *)(ra2))->lane[0]);
          blk->p2_row[6][2] = (float)(ra2->lane[0] + ra0->lane[0] - *nb2w + 2 * (nb1->lane[0] - ra1->lane[0]));
          in63 = *(int16_t *)((uint8_t *)row0_i - 18) + nb1[-1].lane[0] + ra1[-2].lane[0] + ra0->lane[0] - ra0[-1].lane[0] - ra1[-1].lane[0] - nb1[-2].lane[0];
        }
        else
        {
          blk->p2_row[6][0] = (float)nb1->lane[0];
          blk->p2_row[6][1] = (float)nb0[-3].lane[0];
          blk->p2_row[6][2] = (float)(nb0[-1].lane[0] + ra0[-1].lane[0] - ra0[-2].lane[0]);
          in63 = nb0[-3].lane[0] + nb0[-1].lane[0] - nb0[-4].lane[0];
        }
        blk->p2_row[6][3] = (float)in63;
      }
      else
      {
        blk->p2_row[4][0] = (float)(nb0[-3].lane[0] + nb0[-1].lane[0] - nb0[-4].lane[0]);
        blk->p2_row[4][1] = ((float)(nb0[-1].lane[0] + ra0[-1].lane[0] - ra0[-2].lane[0]));
        blk->p2_row[4][2] = (float)(nb1[1].lane[0] + ra1->lane[0] - ra2[1].lane[0]);
        blk->p2_row[4][3] = (float)(nb0[-2].lane[0] + ra1[2].lane[0] - ra1->lane[0]);
        blk->p2_row[5][0] = (float)(nb1->lane[0] + ra0[-2].lane[0] - ra1[-2].lane[0]);
        blk->p2_row[5][1] = (float)(nb1->lane[0] + ra0->lane[0] - ra1->lane[0]);
        blk->p2_row[5][2] = (float)(nb0[-2].lane[0] + ra0->lane[0] - ra0[-2].lane[0]);
        nb2w2 = (int16_t *)blk->cursor[2];
        blk->p2_row[5][3] = (float)(nb0[-2].lane[0] + rb0->lane[0] - rb0[-2].lane[0]);
        blk->p2_row[6][0] = (float)(*nb2w2 + rb0->lane[0] - ((P2Ctx *)(rb2))->lane[0]);
        blk->p2_row[6][1] = (float)(rb0[-2].lane[0]
                                       + rb0->lane[0]
                                       - nb0[-2].lane[0]
                                       + 2 * (nb0[-1].lane[0] - rb0[-1].lane[0]));
        blk->p2_row[6][2] = ((float)(nb0[-2].lane[0] + rb0->lane[2]));
        blk->p2_row[6][3] = (float)(*nb2w2 + ra0->lane[2]);
      }
    }
    else
    {
      blk->p2_row[4][0] = (float)(nb0[-3].lane[0] + nb0[-1].lane[0] - nb0[-4].lane[0]);
      nb3x = blk->cursor[3];
      blk->p2_row[4][1] = (float)(nb0[-5].lane[0] + nb1->lane[0] - nb1[-5].lane[0]);
      nb2x = (P2Ctx *)blk->cursor[2];
      blk->p2_row[4][2] = (float)(nb0[-4].lane[0] + nb1->lane[0] - nb1[-4].lane[0]);
      v68 = nb2x->lane[0] + 3 * nb1[1].lane[0] - 4 * nb2x[1].lane[0];
      blk->p2_row[4][3] = ((float)(v68 - (((nb1[2].lane[0] - nb1->lane[0] - (nb3x[2].lane[0] - nb3x->lane[0])) >> 1) - nb3x[1].lane[0])));
      blk->p2_row[5][0] = (float)(nb0[-2].lane[0] + ra0->lane[0] - ra0[-2].lane[0]);
      blk->p2_row[5][1] = (float)(nb1[1].lane[0] + ra1[1].lane[0] - ra2[2].lane[0]);
      blk->p2_row[5][2] = (float)(nb1[-2].lane[0] + ra1[2].lane[0] - ra2->lane[0]);
      v74 = nb0[-1].lane[0] - ra0[-1].lane[0];
      v75 = ra0[-2].lane[0] + ra0->lane[0] - nb0[-2].lane[0];
      blk->p2_row[5][3] = ((float)(v75 + 2 * v74));
      blk->p2_row[6][0] = (float)(nb2x[1].lane[0] + rb0->lane[0] - rb2[1].lane[0]);
      blk->p2_row[6][1] = ((float)(nb0[-2].lane[0] + rb0->lane[0] - rb0[-2].lane[0]));
      blk->p2_row[6][2] = (float)(nb0[-1].lane[0] + rb1[1].lane[0] - rb1->lane[0]);
      blk->p2_row[6][3] = (float)(nb1[1].lane[0] + rb1[2].lane[0] - rb2[3].lane[0]);
    }
  }
  else
  {
    blk->p2_row[4][0] = (float)(nb1[3].lane[0] + nb1->lane[0] - nb2[3].lane[0]);
    v239 = nb1->lane[0];
    v240 = nb1[-4].lane[0];
    row2c = nb2;
    blk->p2_row[4][1] = (float)(nb0[-4].lane[0] + v239 - v240);
    v241 = nb2->lane[0] + 3 * nb1[1].lane[0] - 4 * nb2[1].lane[0];
    v242 = nb1[2].lane[0] - nb1->lane[0];
    blk->p2_row[4][2] = ((float)(v241 - (((v242 - (nb3[2].lane[0] - nb3->lane[0])) >> 1) - nb3[1].lane[0])));
    nb4 = (P2Ctx *)blk->cursor[4];
    blk->p2_row[4][3] = (float)(row2c[-1].lane[0] + nb1[1].lane[0] - nb3->lane[0]);
    blk->p2_row[5][0] = (float)(nb3[1].lane[0] + nb1->lane[0] - nb4[1].lane[0]);
    blk->p2_row[5][1] = (float)nb1[3].lane[0];
    blk->p2_row[5][2] = (float)(nb0[-3].lane[0] + nb0[-1].lane[0] - nb0[-4].lane[0]);
    blk->p2_row[5][3] = (float)(nb0[-1].lane[0] + nb3->lane[0] - nb3[-1].lane[0]);
    blk->p2_row[6][0] = (float)(nb0[-5].lane[0] + nb1->lane[0] - nb1[-5].lane[0]);
    blk->p2_row[6][1] = (float)nb4->lane[0];
    blk->p2_row[6][2] = (float)(nb0[-5].lane[0] + nb0[-1].lane[0] - nb0[-6].lane[0]);
    blk->p2_row[6][3] = (float)nb1[-6].lane[0];
    rb2 = (P2Ctx *)(nullptr);
    rb1 = (P2Ctx *)(nullptr);
    rb0 = nullptr;
    ra2 = (P2Ctx *)(nullptr);
  ...
  *(int32_t *)&blk->pred_prev = n3536_5;
  ...
  g3pair = v112 + lane3;
  if ( refa )
    g3pair += (rb0->lane[3] + ra0->lane[3]) >> 1;
  v113 = cx0[-2].lane[3];
  v114 = cx0[-3].lane[3];
  n3536 = n3536_5;
  v116 = cx0[-4].lane[3];
  cx3 = (P2Ctx *)(blk->cursor[3]);
  g3sum = cx1[3].lane[3] + cx1[-1].lane[3] + v112 + v114 + v116 + v113;
  n3536_1 = n3536;
  v260 = cx0[-1].lane[2];
  ctx0_lo = (cx1[1].lane[2] + cx1->lane[2] + cx1[-1].lane[2] + v260) & 0x80000
       | (cx3->lane[2] + cx0[-2].lane[2] + 2 * cx0[-4].lane[2]) & 0x40000
       | (cx1[-3].lane[2] + cx0[-3].lane[2] + cx0[-5].lane[2] + cx0[-7].lane[2]) & 0x20000
       | v260 & 0x10000
       | (uint16_t)cx0[-3].lane[2] & 0x8000
  ...
  if ( refa )
  {
    ...
    v124 = ra0[-1].lane[2];
    n3536 = n3536_1;
    ctx0 = rb0[-1].lane[2] & 0x2000000
         | rb0->lane[2] & 0x1000000
         | v124 & 0x800000
         | (rb0->lane[2] + rb0[-2].lane[2]) & 0x400000
         | (v121 + lane2) & 0x200000
         | v122 & 0x100000
         | ctx0_lo;
  ...
  else
  {
    ...
    n3536 = n3536_1;
    cx2 = (P2Ctx *)blk->cursor[2];
    ctx0 = (cx1[3].lane[2] + cx0[-3].lane[2] + v238 + v237) & 0x2000000
         | (cx2[1].lane[2] + cx2->lane[2] + v236 + cx0[-8].lane[2]) & 0x1000000
         | (v236 + cx0[-6].lane[2]) & 0x800000
         | v236 & 0x400000
         | v237 & 0x200000
         | v238 & 0x100000
         | ctx0_lo;
  ...
  if ( refa )
  {
    ...
    v270 = cx1[2].lane[1];
    q10a = q10;
    ctx1 = (cx0[-1].lane[0] + ra0->lane[0] - ra0[-1].lane[0] - n2256) & 0x2000000
         | (ra2->lane[1] + ra1->lane[1] - 2 * ra0->lane[1]) & 0x1000000
         | ((v248 + cx0[-3].lane[1] - n2256 - (v270 - cx1[5].lane[1])) & 0x800000 | (v248 + cx0[-5].lane[1] - n2256) & 0x400000 | (v248 + cx1->lane[1] + rb1[2].lane[1] - rb2[2].lane[1] - n2256) & 0x200000 | (v248 + cx0[-1].lane[1] + rb0->lane[1] - rb0[-1].lane[1] - n2256) & 0x100000 | (cx2[-1].lane[1] + v248 + v134 - ra2[-1].lane[1] - n2256) & 0x80000 | (v248 + v270 + v134 - ra1[2].lane[1] - n2256) & 0x40000 | n1840_2 & 0x20000 | n1840_1 & 0x10000 | n960_1 & 0x8000 | (((n2256 > 2256) + (n2256 > 1056) + (n2256 > 144)) << 13) | ((((uint32_t)(55 - sum_all) >> 20) & 0xFFFFF800) + q10 + q24));
  }
  else
  {
    q10 = ((uint32_t)(10 - sum_all) >> 20) & 0xFFFFF800;
    v254 = cx3->lane[0];
    v267 = n2256 - cx0[-3].lane[0];
    v273 = cx1[2].lane[0];
    ctx1 = (cx1[-5].lane[0] - cx1[-2].lane[0] + v267) & 0x1000000
         | (v267 + v273 - v301) & 0x800000
         | (cx4[3].lane[0] - cx2[2].lane[0] + n2256 - cx2[1].lane[0]) & 0x400000
         | (cx4[-1].lane[0] - v254 + n2256 - cx1[-1].lane[0]) & 0x200000
         | (cx1->lane[0] - v273 + n2256 - cx0[-2].lane[0]) & 0x100000
         | -n1840_2 & 0x80000
         | -n1840_1 & 0x40000
         | (n2256 - cx4[2].lane[0]) & 0x20000
         | (n2256 - cx4[-3].lane[0]) & 0x10000
         | -n960_1 & 0x8000
         | (((n2256 > 2400) + (n2256 > 1024) + (n2256 > 240)) << 13)
         | (q39 + q24 + (((uint32_t)(11 - sum_all) >> 20) & 0xFFFFF800))
         | (n1840 - v254 + n2256 - cx1[4].lane[0]) & 0x2000000;
    q10a = q10;
  }
  q10 = q10a;
  bank1 = ctx1 >> 11;
  ...
  n1840 = n1840_13;
  v302 = v147 - n2576;
  v301 = v147 + n2576 - 2 * cx0[-1].lane[0];
  v303 = n1840_13 - n2576;
  if ( refa )
  {
    v148 = cx0[0].lane[1];
    v149 = cx0[-1].lane[1];
    v151 = ra0->lane[0];
    n1840_2 = cx1[1].lane[1];
    n1840_1 = v151 - n2576;
    q10b = q10;
    ctx2 = (v148 + cx1[-1].lane[1] - n2576 - (cx2->lane[1] - n1840_2)) & 0x2000000
         | (v148 + v149 - n2576 - (cx1->lane[1] - n1840_2)) & 0x1000000
         | (rb0->lane[0] - n2576 + n1840 - rb2->lane[0]) & 0x800000
         | (n1840_1 + n1840 - ra2->lane[0]) & 0x400000
         | (n1840_1 + cx1[-1].lane[0] - ra1[-1].lane[0]) & 0x200000
         | ((v148 - cx0[-2].lane[1] + 2 * v149 - n2576) & 0x100000 | (2 * n960_1 - n2576 - n1840) & 0x80000 | -v301 & 0x40000 | v303 & 0x20000 | v302 & 0x10000 | (208 - rb0->lane[0]) & 0x8000 | (((n2576 > 2576) + (n2576 > 1280) + (n2576 > 640)) << 13) | ((((uint32_t)(33 - sum_all) >> 31) + ((uint32_t)(12 - sum_all) >> 31) + ((uint32_t)(4 - sum_all) >> 31)) << 11));
  }
  else
  {
    v235 = cx3->lane[0];
    ...
    ctx2 = (n2576 + 3 * (n1840 - n960_1) - v235) & 0x2000000
         | (n2576 + v266 - (cx2[2].lane[0] + cx2[-2].lane[0])) & 0x1000000
         | (cx3[2].lane[0] - cx2[-1].lane[0] + n2576 - cx1[3].lane[0]) & 0x800000
         | (v272 - cx1[1].lane[0] - v303) & 0x400000
         | (v235 - n960_1 - v303) & 0x200000
         | v301 & 0x100000
         | (n2576 - cx4[3].lane[0]) & 0x80000
         | (v272 - n2576) & 0x40000
         | (n2576 - v266) & 0x20000
         | (n2576 - cx3[-2].lane[0]) & 0x10000
         | -v302 & 0x8000
  ...
  q9 = 9 - sum_all;
  sum_all = -sum_all;
  bank3 = (int32_t)((3 * (v162 - cx0[-1].lane[0]) + n2896 - v163) & 0x2000000
             | (v164
              - ((uint32_t)(cx1[1].lane[1] + cx1[2].lane[1] + cx1[-1].lane[1] + v161) >> 1)
              + v306)
             & 0x1000000
             | (cx2[-3].lane[0] - cx1[-2].lane[0] + n2896 - cx1[-1].lane[0]) & 0x800000
             | -(cx2[2].lane[0] + n2896 - 2 * cx1[1].lane[0]) & 0x400000
             | (cx1[-2].lane[1] - v162 + n2896 - v161) & 0x200000
             | (n2896 - cx1[3].lane[0]) & 0x100000
             | (v306 - v164) & 0x80000
             | (n2896 - cx3->lane[0]) & 0x40000
             | (2 * n2896 - v161 - (cx1->lane[0] + v250)) & 0x20000
             | (n2896 - cx0[-1].lane[1] - v250) & 0x10000
             | (n2896 - v163) & 0x8000
  ...
  v182 = n3536_2 - cx0[-1].lane[0];
  n3536_3 = n3536;
  v185 = (int32_t)((n3536 - ((uint32_t)(v178 + v179 + 2 * v175) >> 2)) & 0x2000000
             | (v313 - cx0[-2].lane[0] - (cx3[2].lane[1] + v307)) & 0x1000000
             | (n3536 - 2 * cx0[-2].lane[1] - (v307 - v177)) & 0x800000
             | (n3536 - cx0[-3].lane[1] - v307 - (v175 - cx1[-3].lane[0])) & 0x400000
             | (v313 - v307 - (v178 + cx2[-1].lane[1])) & 0x200000
             | (cx2[-2].lane[0] + n3536 - 2 * v179) & 0x100000
             | (cx2->lane[1] - 2 * cx1->lane[1] + v312) & 0x80000
             | (v182 - (v175 - v179)) & 0x40000
             | (v312 - cx1[4].lane[1]) & 0x20000
             | (v312 - cx1[-2].lane[1]) & 0x10000
             | v181
             | ((((n3536_2 > 3056) + (n3536_2 > 1952) + (n3536_2 > 368)) << 13) | (q39 + (((uint32_t)(sum_all + 21) >> 20) & 0xFFFFF800) + q10))) >> 11;
  blk->bank_ctx[4] = v185;
  v186 = p2_pred(blk->p2_ctr[v185 + 131072].w2, blk->p2_ctr[v185 + 131072].b0);
  cx2p = (uint8_t *)cx2;
  blk->nb_sum[9] = v186;
  n1840 = n3536_3 + v186;
  blk->nb_sum[8] = n3536_3 + v186;
  v188 = cx1[-1].mag;
  v189 = cx2p[17];
  v190 = cx2p[89];
  v191 = v188 + cx0[-2].mag + v189;
  v192 = *(cx2p - 19);
  v193 = cx3[2].mag
       + cx3[1].mag
       + cx3[-1].mag
  ...
  blk->ctx_w[1].sel = v200;
  n1840_17 = n1840_14 - cx0[-1].lane[0];
  v203 = n1840_17 < n1840_1;
  v26 = n1840_17 <= n1840_16;
  blk->ctx_w[2].sel = v26 + v203;
  ...
  if ( refa )
  {
    ...
    v212 = rb0[-1].mag;
    v213 = ra0[-1].mag;
    v251 = rb1->mag + ra1->mag;
    v264 = mag + ra0->mag;
    n960 = v251 + n960_1 + 4 * v264 + 2 * (v213 + v212);
    v214 = v264 + v301 + rb0[-2].mag + v212 + ra0[-2].mag + v213;
    n3536_4 = n3536;
    if ( blk->has_ref )
    {
      n1840_3 = n1840 - cx1->lane[1] - cx0[0].lane[1];
      if ( n1840_3 < n1840_1 || n1840_3 > n1840_2 )
      {
        n1840 = n1840 - cx0[-1].lane[1] - cx0[0].lane[1];
    ...
    {
      v215 = v251 + v264 + v302 + rb2->mag + ra2->mag;
    }
    if ( *(int32_t *)&blk->plane_idx == 1 )
    {
      n960_1 = n960;
      n1840_4 = n1840_2;
      n1840_5 = ra0->lane[0] - ra1->lane[0];
      blk->ctx_w[3].sel = (n1840_5 <= n1840_2) + (n1840_5 < n1840_1);
      n1840_6 = ra0->lane[0] - ra0[-1].lane[0];
      v234 = (n1840_6 <= n1840_4) + (n1840_6 < n1840_1);
      v214 = v214;
      n960 = n960_1;
      n3536_4 = n3536;
      blk->ctx_w[4].sel = v234;
    }
    else if ( *(int32_t *)&blk->plane_idx > 1 )
    {
      n960_1 = n960;
      n1840_7 = n1840_2;
      n1840_8 = rb0->lane[0] - rb1->lane[0];
      blk->ctx_w[3].sel = (n1840_8 <= n1840_2) + (n1840_8 < n1840_1);
      n1840_10 = rb0->lane[0] - rb0[-1].lane[0];
      n1840_9 = n1840_1;
      v222 = n1840_10 < n1840_1;
      v26 = n1840_10 <= n1840_7;
      v215 = v215;
      n960 = n960_1;
      blk->ctx_w[4].sel = v26 + v222;
      v224 = ra0->lane[0];
      n1840_11 = v224 - ((P2Ctx *)(ra1))->lane[0];
  ...
  {
    v214 = v301 + cx0[-3].mag + cx0[-4].mag + cx0[-5].mag;
    v215 = cx4->mag + cx3->mag + v302 + cx0[0].mag;
  }
  if ( n960 >= 960 )
  {
    n15 = 15;
...
void __reduce_alphabet(ModelBlock *blk, int8_t a2, uint8_t *src)
{
  ...
  uint32_t k_2, i, written, li, n0x2000_4, n0x2000_3, word, k, pairs, j_1, j,
...
int32_t __cost_candidate(uint8_t *img, int32_t cand, uint8_t *desc, int8_t a4, int32_t a5, int32_t a6, int32_t a7, uint32_t *costs)
{
  ...
  __frame.n2_1 = (uint8_t *)cand;   // the slot is reused as an address below
  __frame.r0_f = img;
  __frame.desc_f = desc;
  ...
  __frame.n2_2 = cand;
  __frame.img_f = img;
  __frame.d1_f = (int32_t)(__frame.n2_1 + 1) % 3 - (uint32_t)__frame.n2_1;
  __frame.d2_f = (int32_t)(__frame.n2_1 + 2) % 3 - (uint32_t)__frame.n2_1;
  ...
  *(uint32_t *)__frame.buf_1 = row_b;
  ...
  sxy = 0.0;
  sxx = 0.0;
  __frame.rec_off = 16 * __frame.n2_2;
  __frame.desc_f[16 * __frame.n2_2] = 2;
  __frame.desc_f[33] = (uint8_t)cand2;
  cand_base = (int32_t)&base[cand2];
  p = &base[cand2 + 16 + row_b2 + __frame.n4];
  if ( (uint32_t)p < __frame.img_end )
  {
    __frame.d1_f = d1;
    *(uint32_t *)__frame.buf_1 = row_b2;
    __frame.off_a2 = d1 - row_b2;
    __frame.off_a1 = d1 - row_b2 - __frame.n4;
    __frame.off_a0 = d1 - __frame.n4;
    __frame.off_b2 = __frame.d2_f - row_b2;
    __frame.off_b1 = __frame.d2_f - row_b2 - __frame.n4;
    __frame.off_b0 = __frame.d2_f - __frame.n4;
    __frame.step_d = row_b2 + __frame.n4;
    do
    {
      d2 = __frame.d2_f;
  ...
  __frame.n2_1 = (uint8_t *)(__frame.d2_f + at + 16);
  r2 = __frame.n2_1;
  r1 = (uint8_t *)at1;
  do
  {
    ...
    e2 = *r1;
    left = __frame.rows;
    r2 = &__frame.n2_1[-nstep];
    bin2 = ((uint16_t)e1
         - (uint16_t)((__frame.n191_2 * (r1[__frame.off_up] + e2 - r1[__frame.best] - r1[nstep])
                             + __frame.n191_5 * (__frame.n2_1[__frame.off_up] + *__frame.n2_1 - __frame.n2_1[__frame.best] - (uint32_t)__frame.n2_1[nstep])
                             + 40) >> 7)
         - 256)
        & 0x1FF;
    r1 -= nstep;
  ...
  rec = 4 * __frame.n2_2;   // this candidate's four-word record
  costs[rec] = c0;
  ...
  *(uint32_t *)&__frame.desc_f[__frame.rec_off + 4] = __frame.n191_2;
  *(uint32_t *)&descp[off + 8] = __frame.n191_5;
  idx1 = __frame.n2_2 + pick;
  idx2 = __frame.n2_2 + __frame.d2_f;
  descp[16 * idx1] = 0;
...
int32_t __choose_plane_coding(BmfImage *img, int32_t unused_h, int8_t unused_c)
{
  ...
  struct alignas(16) ChoosePlaneCodingFrame {   // 41456 bytes, one stack frame
      ...
      // `buf[4096 * pred]` walks; `char buf[4]` was the first four bytes of it.
      union {
          uint8_t buf[32768];
          struct {
      ...
      alignas(16) int32_t x0[4];
      alignas(16) int32_t x1[4];
      alignas(16) int32_t x2[4];
      ...
      uint32_t data_end;
      uint8_t _pad6[4];
      // A second copy of `img`, stored on entry and never read again.  The
      // slot stays so the frame keeps its size; the store is gone.
      uint8_t _pad5[4];
      uint8_t _pad7[28];
  } __frame;
  ...
  int16_t g1_lo;
  int32_t n4, data_size, result, row, next_plane, pick01, xform, dw, *win_row,
          wt8, wt4, c2, c2w, c1, c1w, c0, bin0, slack, pred, xform_row, win,
          sum, best_sum, i, pos2, best_sum2, sum2, wt4_dn, wt4_c, wt8_dn,
          wt8_c, wt4_dn_end, wt8_dn_end, n_quads, dv3, wa, wb, wc, nx0, dg0,
          dn0, ad0, dnx1, g0, dn1, nx2, g1, dnx2, g2, pa, pb, bin_lin, quad_r,
          alpha, bin_lin2, r0, r1, r2, wa_pick, pred4, pred4b, *hist2, sum3,
          best_sum3, npix_c, stride_c, left_c, ul_c, g_c, cur_c, n_c, bin_c,
          wt4_best_dn, npix_d, stride_d, left_d, ul_d, g_d, cur_d, n_d, bin_d,
          wt8_best_dn, wt4_up, wt8_up, wt4_up_end, wt8_up_end, npix_a,
          stride_a, left_a, r_a, ul_a, g_a, cur_a, n_a, bin_a, wt4_best,
          npix_b, stride_b, left_b, r_b, ul_b, g_b, cur_b, n_b, bin_b,
          wt8_best;
  ...
  uint8_t *px, *end_px, *row1, *q_c, *r_c, *p_c, *q_d, *r_d, *p_d, *q_a, *p_a, *q_b, *p_b;
  n4 = plane_count;
  ...
  do
  {
    bmf_zero16(((uint8_t *)&__frame.acc1[4] + result));
    bmf_zero16(((uint8_t *)&__frame.acc1[2] + result));
    bmf_zero16(((uint8_t *)__frame.acc1 + result));
    bmf_zero16(((uint8_t *)__frame.acc0 + result));
    result -= 64;
  }
  while ( result );
  if ( n4 > 0 )
  {
    ...
    if ( n4 >= 3 )
    {
      cost0 = __cost_candidate((uint8_t *)__frame.img_a, 0, (uint8_t *)__frame.tbl16, unread0, __frame.best0, __frame.best1, __frame.best2, (uint32_t *)&__frame.acc0[2]);
      cost1 = __cost_candidate((uint8_t *)__frame.img_a, 1, __frame.tbl64a, unread1, __frame.best0, __frame.best1, __frame.best2, (uint32_t *)&__frame.acc0[2]);
      keep0 = cost1 >= cost0;
      if ( cost1 >= cost0 )
        cost1 = cost0;
      pick01 = !keep0;
      __frame.x3[2] = pick01;
      cheaper = __cost_candidate((uint8_t *)__frame.img_a, 2, __frame.tbl64b, unread2, __frame.best0, __frame.best1, __frame.best2, (uint32_t *)&__frame.acc0[2]) < cost1;
      xform = pick01;
      if ( cheaper )
        xform = 2;
      __frame.x3[2] = xform;
      dw = 16;
      win_row = &__frame.tbl16[16 * xform];
      do
      {
      ...
      // is jumped to from inside it.)
      {
        ...
        wt4_c = wt4;
        wt8_dn = wt8 - 1;
        __frame.s0 = wt4_c - __frame.x0[1];
        wt8_c = wt8;
        wt4_dn_end = __frame.s0;
        *(uint32_t *)__frame.buf_1 = wt8_c - __frame.x0[1];
        __frame.x0[0] = (int32_t)&((uint8_t *)__frame.img_a)[__frame.x3[2]];
        wt8_dn_end = wt8_c - __frame.x0[1];
        while ( 1 )
        {
            ...
            if ( wt8_dn <= wt8_dn_end )
            {
              ...
              while ( 1 )
              {
                ...
                if ( wt4_up < 192 )
                {
                  ...
                  memset(__frame.buf_1,0,2048);
                  npix_a = __frame.img_a->width * (__frame.img_a->height - 1);
                  stride_a = (uint16_t)__frame.img_a->stride;
                  __frame.x3[3] = wt8_up;
                  __frame.x1[0] = wt4_up;
                  __frame.x1[1] = npix_a - 1;
                  __frame.x3[0] = best_cost;
                  __frame.x2[1] = -stride_a;
                  left_a = -plane_count;
                  __frame.x2[0] = -stride_a - plane_count;
                  ...
                  do
                  {
                    ul_a = p_a[__frame.x2[0]];
                    *(int64_t *)&__frame.x1[2] = __PAIR64__((uint32_t)p_a, q_a);
                    __frame.x2[2] = r_a;
                    g_a = ul_a + *p_a - p_a[__frame.x2[1]] - p_a[left_a];
                    cur_a = *q_a;
                    __frame.x2[3] = g_a;
                    r_a = __frame.x2[2] - left_a;
                    n_a = __frame.x1[1];
                    bin_a = (((int16_t *)__frame.x2)[6]
                          - (uint16_t)((__frame.x1[0]
                                              ...
                                              * (*(uint8_t *)(__frame.x2[2] + __frame.x2[0])
                                               ...
                                               - (uint32_t)*(uint8_t *)(__frame.x2[2] + left_a))
                                              + 40) >> 7)
                          - 256)
                         & 0x1FF;
                    ++*(uint32_t *)&__frame.buf_1[4 * bin_a];
                    q_a -= left_a;
                    p_a = (uint8_t *)(__frame.x1[3] - left_a);
                    __frame.x1[1] = n_a - 1;
                  }
                  while ( n_a != 1 );
                  wt8_up = __frame.x3[3];
                  ...
                  wt8_up_end = __frame.x0[2];
                  wt4_best = __frame.x5[3];
                  if ( cost_a < best_cost )
                  {
                    best_cost = cost_a;
                    wt4_best = wt4_up;
...
LABEL_109:
                  if ( wt8_up < 192 )
                  {
                    ...
                    npix_b = __frame.img_a->width * (__frame.img_a->height - 1);
                    stride_b = (uint16_t)__frame.img_a->stride;
                    __frame.x3[3] = wt8_up;
                    __frame.x1[0] = wt4_up;
                    __frame.x4[0] = npix_b - 1;
                    __frame.x3[0] = best_cost;
                    __frame.x5[0] = -stride_b;
                    left_b = -plane_count;
                    __frame.x4[3] = -stride_b - plane_count;
                    ...
                    do
                    {
                      ul_b = p_b[__frame.x4[3]];
                      *(int64_t *)((uint8_t *)__frame.x4 + 4) = __PAIR64__((uint32_t)p_b, q_b);
                      __frame.x5[1] = r_b;
                      g_b = ul_b + *p_b - p_b[__frame.x5[0]] - p_b[left_b];
                      cur_b = *q_b;
                      __frame.x5[2] = g_b;
                      r_b = __frame.x5[1] - left_b;
                      n_b = __frame.x4[0];
                      bin_b = (((int16_t *)__frame.x5)[4]
                            - (uint16_t)((__frame.x5[3]
                                                * (q_b[__frame.x4[3]] + cur_b - q_b[__frame.x5[0]] - q_b[left_b])
                                                + __frame.x3[3]
                                                * (*(uint8_t *)(__frame.x5[1] + __frame.x4[3])
                                                 + *(uint8_t *)__frame.x5[1]
                                                 - *(uint8_t *)(__frame.x5[1] + __frame.x5[0])
                                                 - (uint32_t)*(uint8_t *)(__frame.x5[1] + left_b))
                                                + 40) >> 7)
                            - 256)
                           & 0x1FF;
                      ++*(uint32_t *)&__frame.buf_2[4 * bin_b];
                      q_b -= left_b;
                      p_b = (uint8_t *)(__frame.x4[2] - left_b);
                      __frame.x4[0] = n_b - 1;
                    }
                    while ( n_b != 1 );
                    wt8_up = __frame.x3[3];
          ...
          if ( wt4_dn >= -64 )
          {
            *(uint32_t *)__frame.buf_1 = wt8_dn_end;
            ...
            npix_c = __frame.img_a->width * (__frame.img_a->height - 1);
            stride_c = (uint16_t)__frame.img_a->stride;
            __frame.s6 = wt8_dn;
            __frame.s1 = wt4_dn;
            __frame.s2 = npix_c - 1;
            __frame.x3[0] = best_cost;
            ...
            do
            {
              ...
              bin_c = ((uint16_t)__frame.s5
                    ...
                    - 256)
                   & 0x1FF;
              ++*(uint32_t *)&__frame.buf_3[4 * bin_c];
              q_c -= left_c;
            ...
            wt4_dn = __frame.s1;
            best_cost = __frame.x3[0];
            cost_c = __estimate_cost((uint8_t *)__frame.buf_3, 512);
            wt8_dn_end = *(uint32_t *)__frame.buf_1;
            wt4_best_dn = __frame.x5[3];
            if ( cost_c < best_cost )
            {
              best_cost = cost_c;
              wt4_best_dn = wt4_dn;
...
LABEL_55:
            if ( wt8_dn >= -64 )
            {
              ...
              npix_d = __frame.img_a->width * (__frame.img_a->height - 1);
              stride_d = (uint16_t)__frame.img_a->stride;
              __frame.s6 = wt8_dn;
              __frame.s1 = wt4_dn;
              __frame.s7 = npix_d - 1;
              __frame.x3[0] = best_cost;
              ...
              do
              {
                ...
                bin_d = ((uint16_t)__frame.s10
                      - (uint16_t)((__frame.x5[3] * (q_d[__frame.s8] + cur_d - q_d[__frame.s9] - q_d[left_d])
                                          + __frame.s6 * (__frame.p5[__frame.s8] + *__frame.p5 - __frame.p5[__frame.s9] - (uint32_t)__frame.p5[left_d])
                                          + 40) >> 7)
                      - 256)
                     & 0x1FF;
                ++*(uint32_t *)&__frame.buf_4[4 * bin_d];
                q_d -= left_d;
...
LABEL_19:
      px = &((uint8_t *)__frame.img_a)[__frame.q0 + 16 + n4 + __frame.x3[2]];
      ...
      cost_flat = *(int32_t *)((uint8_t *)&__frame.acc0[3] + __frame.x3[1]);
      cheaper = cost_flat < best;
      if ( cost_flat < best )
      {
        best = *(int32_t *)((uint8_t *)&__frame.acc0[3] + __frame.x3[1]);
        wt4 = 128;
        wt8 = 0;
      }
      pred = cheaper;
      if ( *(uint32_t *)((uint8_t *)__frame.acc1 + __frame.x3[1]) < best )
      {
        best = *(uint32_t *)((uint8_t *)__frame.acc1 + __frame.x3[1]);
        pred = 2;
        wt4 = 0;
        wt8 = 128;
      }
      keep3 = best <= *(uint32_t *)((uint8_t *)__frame.acc1 + __frame.x3[1] + 4);
      if ( best > *(uint32_t *)((uint8_t *)__frame.acc1 + __frame.x3[1] + 4) )
        pred = 3;
      xform_row = __frame.x3[2];   // a record index; it was the byte offset 16 * it
      if ( !keep3 )
      {
        wt4 = 64;
        wt8 = 64;
      }
      plane_desc[__frame.x3[2] + 1].w4 = wt4;
      ...
      if ( n4 >= 4 )
      {
        ...
        __builtin_memset(__frame.x1, 0, 16);
        __builtin_memset(__frame.x2, 0, 16);
        __builtin_memset(__frame.x3, 0, 16);
        __builtin_memset(__frame.x4, 0, 16);
        __builtin_memset(__frame.x5, 0, 16);
        memset(__frame.buf,0,0x8000);
        __frame.pp = &((uint8_t *)__frame.img_a)[__frame.q0];
        n_quads = (int32_t)(__frame.data_end - 17 - (uint32_t)&((uint8_t *)__frame.img_a)[__frame.q0]) / 4;
        end_px = &((uint8_t *)__frame.img_a)[__frame.q0 + 20];
        if ( __frame.data_end <= (uint32_t)end_px )
        {
          sum01 = *(double *)&__frame.x0[2];
          sum02 = *(double *)__frame.x1;
          sum12 = *(double *)&__frame.x2[2];
          __frame.q1 = *(int64_t *)&__frame.x0[2];
          __frame.q0 = *(int64_t *)&__frame.x2[2];
          __frame.d4 = *(double *)__frame.x0;
          __frame.q2 = *(int64_t *)&__frame.x4[2];
          sum02_c = *(double *)__frame.x1;
        }
        else
        {
          sum22 = *(double *)__frame.x4;
          sum11 = *(double *)__frame.x2;
          __frame.q2 = *(int64_t *)&__frame.x4[2];
          __frame.d4 = *(double *)__frame.x0;
          __frame.d5 = *(double *)&__frame.x0[2];
          __frame.d2 = *(double *)__frame.x1;
          ...
          do
          {
            dv0 = (double)(((uint8_t *)__frame.img_a)[4 * i4 + 16] + __frame.pp[4 * i4 + 20] - (((uint8_t *)__frame.img_a)[4 * i4 + 20] + __frame.pp[4 * i4 + 16]));
            dv1 = (double)(((uint8_t *)__frame.img_a)[4 * i4 + 17] + __frame.pp[4 * i4 + 21] - (((uint8_t *)__frame.img_a)[4 * i4 + 21] + __frame.pp[4 * i4 + 17]));
            dv2 = (double)(((uint8_t *)__frame.img_a)[4 * i4 + 18] + __frame.pp[4 * i4 + 22] - (((uint8_t *)__frame.img_a)[4 * i4 + 22] + __frame.pp[4 * i4 + 18]));
            dv3 = ((uint8_t *)__frame.img_a)[4 * i4 + 19] + __frame.pp[4 * i4 + 23] - (((uint8_t *)__frame.img_a)[4 * i4 + 23] + __frame.pp[4 * i4 + 19]);
            __frame.d4 = __frame.d4 + dv0 * dv0;
            ++i4;
            __frame.d5 = __frame.d5 + dv0 * dv1;
            __frame.d2 = __frame.d2 + dv0 * dv2;
            sum11 = sum11 + dv1 * dv1;
            __frame.d6 = __frame.d6 + dv1 * dv2;
            sum22 = sum22 + dv2 * dv2;
            *(double *)&__frame.q2 = *(double *)&__frame.q2 + dv0 * (double)dv3;
            __frame.d3 = __frame.d3 + dv1 * (double)dv3;
            __frame.d1 = __frame.d1 + dv2 * (double)dv3;
          }
          while ( i4 < __frame.uu );
          sum01 = __frame.d5;
          sum02 = __frame.d2;
          ...
          *(int64_t *)&__frame.x4[2] = __frame.q2;
          *(double *)__frame.x4 = sum22;
          *(double *)&__frame.x2[2] = __frame.d6;
          *(double *)__frame.x2 = sum11;
          *(double *)__frame.x1 = __frame.d2;
          *(double *)&__frame.x0[2] = __frame.d5;
          *(double *)__frame.x0 = __frame.d4;
          sum02_c = __frame.d2;
          *(double *)&__frame.q0 = __frame.d6;
          *(double *)&__frame.q1 = __frame.d5;
        }
        __frame.d5 = sum01;
        __frame.d6 = sum12;
        __frame.d0 = sum02_c;
        *(double *)&__frame.x1[2] = sum01;
        *(double *)__frame.x3 = sum02;
        *(double *)&__frame.x3[2] = sum12;
        __frame.d1 = __frame.d4 * *(double *)__frame.x4 - sum02_c * sum02;
        __frame.d2 = 0.0 - __frame.d4 * sum12 + sum02 * *(double *)&__frame.q1;
        __frame.d3 = sum02_c * sum12 - *(double *)&__frame.q1 * *(double *)__frame.x4;
        inv = 128.0 / (*(double *)__frame.x2 * __frame.d1 + *(double *)&__frame.q0 * __frame.d2 + sum01 * __frame.d3 + 0.1);
        *(double *)__frame.acc0 = inv;
        wa = (int32_t)(((sum02 * *(double *)&__frame.q0 - sum01 * *(double *)__frame.x4) * *(double *)__frame.x5
                    + (0.0 - sum02 * *(double *)__frame.x2 + sum01 * __frame.d6) * *(double *)&__frame.x5[2]
                    + (*(double *)__frame.x4 * *(double *)__frame.x2 - __frame.d6 * *(double *)&__frame.q0)
                    * *(double *)&__frame.q2)
                   * inv);
        if ( wa >= 191 )
          wa = 191;
        ...
        if ( wb < -64 )
          wb = -64;
        wc = (int32_t)(*(double *)__frame.acc0
                     * ((__frame.d4 * *(double *)&__frame.x5[2] - __frame.d0 * *(double *)&__frame.q2) * *(double *)__frame.x2
                      + (0.0 - __frame.d4 * *(double *)__frame.x5 + *(double *)&__frame.q2 * *(double *)&__frame.q1)
                      * *(double *)&__frame.q0
                      + (__frame.d0 * *(double *)__frame.x5 - *(double *)&__frame.q1 * *(double *)&__frame.x5[2]) * __frame.d5));
        if ( wc >= 191 )
          wc = 191;
        if ( wc < -64 )
          wc = -64;
        if ( (uint32_t)end_px < __frame.data_end )
        {
          *(int64_t *)__frame.x0 = __PAIR64__(wc, wb);
          __frame.uu = n_quads;
          quad = 0;
          do
          {
            nx0 = ((uint8_t *)__frame.img_a)[4 * quad + 20];
            dg0 = ((uint8_t *)__frame.img_a)[4 * quad + 16] + __frame.pp[4 * quad + 20];
            dn0 = __frame.pp[4 * quad + 16];
            __frame.x0[2] = quad;
            ad0 = nx0 + dn0;
            dnx1 = __frame.pp[4 * quad + 21];
            g0 = dg0 - ad0;
            dn1 = __frame.pp[4 * quad + 17];
            __frame.x0[3] = g0;
            nx2 = ((uint8_t *)__frame.img_a)[4 * quad + 22];
            g1 = ((uint8_t *)__frame.img_a)[4 * quad + 17] + dnx1 - (((uint8_t *)__frame.img_a)[4 * quad + 21] + dn1);
            dnx2 = __frame.pp[4 * quad + 22];
            __frame.x1[0] = g1;
            g2 = ((uint8_t *)__frame.img_a)[4 * quad + 18] + dnx2 - (nx2 + __frame.pp[4 * quad + 18]);
            ...
            r0 = alpha - row1[4 * quad_r + 20];
            ++__frame.hist_c[r0 + 2048];
            r1 = alpha - row1[4 * quad_r + 21];
            ++__frame.hist_c[r1 + 3072];
            r2 = alpha - row1[4 * quad_r + 22];
            ++__frame.hist_c[r2 + 4096];
            quad = quad_r + 1;
          }
          while ( quad < __frame.uu );
          wc = __frame.x0[1];
          wb = __frame.x0[0];
        }
...
int32_t __decode_pixel(ModelBlock *_this, int32_t a2)
{
  ...
  int32_t n4_8, n4_7, n15_6, n15_7, m_lo, m_up, nb, key, ctx_state, n4_9,
          __decode_pixel_n15, ctx_bucket, n4_11, m_w1, nb2, all_up, sig1, n0xFFFF, sig2,
          n0xFFFF_1, n53248, n4_12, m_up0, n15_11, run, n15_12, bit, n4_22,
          n15_14, n15_18, mask, seen, n0, n4_13, *recw, flags_word, n15_13, done,
          n15_15, n4_17, tot, target, cum, n4, n256_2, n15_1, n256_1, n15_23,
          n4_19, n4_20, n4_5, n4_6, n15_5, c4, c5, c6, c7, h11, h10,
          h12, h13, h14, h15, h16, h17, h18, h19, h20, h21, h24,
          h28, h26, h30, h31, psym, bit2, n32, n15_25, n4_21, lsym, n256,
          b15, n4_18, n15_19, n15_20, w5, w0r, w1r, q1, w2r, w3,
          w3r, n15_21, n3, w4r, n4r, target2, cum2, n4_2, n15_22, n256_4,
          n256_5, n256_3, n15_2;
  FreqRec *freq3;
  ...
  uint16_t *pixp, *pixr, n1, tot2,
           k0;
  SymList *sel1_list;
  SymList **sel_p;
  uint32_t bin_tot, n4_16, n4_15, g2, g1, g0, g3, g4, k1, k2, k2h, k3,
           k4;
  ...
  __frame.sym3 = n15_6;
  ::mode_symbol[3] = n15_6;
  m_lo = n15_9->match[1] + 4 * (n15_6 == n15_7);
  m_up = n15_9[1].match[1];
  __frame.sym2 = n15_7;
  mode_symbol[4] = n15_7;
  ...
  if ( n4_8 == n4_7 )
  {
    ...
    {
      key = (uint16_t)(__frame.sym5->sym_rev[n4_8] - __frame.sym3);
    }
  }
  else
  {
    key = (uint16_t)(__frame.sym5->sym_rev[n4_8] - __frame.sym1);
  }
  ...
  all_up = ((uint8_t)(((PixRec *)__frame.sym6)->match[0] & r8->match[0] & __frame.sym2 & r7->match[0]) << 9)
      + ((uint8_t)(((PixRec *)__frame.sym6)->match[1] & r8->match[1] & r7->match[1] & n15_9->match[1]) << 8)
      + (ctx_bucket << 10)
      + nb2;
  ...
  sig1 = ((__frame.sym5->grad[3] == 0) << 7)
      ...
      + all_up;
  n0xFFFF = __frame.sym5->ctx_id1[sig1];
  if ( n0xFFFF == 0xFFFF )
  {
  ...
  sig2 = row[-1].match[5] + 4 * n15_10[1].match[3] + 2 * __frame.sym2 + 8 * n0xFFFF;
  ...
  if ( (_this->row_cur[5][-1].match[1] & _this->row_cur[5][-1].match[0]) != 0 )
  {
        ...
        & up2[3].match[1]) != 0 )
    {
      ...
      else
      {
        ...
        {
          run = n15_11;
          if ( (up1[n15_11 + 2].match[1] & up1[n15_11 + 2].match[0]) == 0 )
            break;
...
LABEL_42:
      ...
      // Record `8 * n15_12 + 4 * (two neighbour flags) + 2 * m_up0 + sym + 1`
      ...
      n4_22 = ::mode_symbol[1];
      _this->hit = bit;
      *(((uint8_t *)_this->alpha_map) + n4_22) = bit;
      n15_14 = _this->hit;
      if ( n15_14 )
      {
        n15_18 = n15_11;
      ...
      else
      {
        ...
        do
        {
          ...
          {
            n0 = __frame.sym5->run_ctr[16 * ((seen == 0) + (n15_12 == __frame.sym0)) + n15_12].n[0];
            __frame.sym2 = (int32_t)&__frame.sym5->run_ctr[16 * ((seen == 0) + (n15_12 == __frame.sym0)) + n15_12];
            bin_tot = n0 + __frame.sym5->run_ctr[16 * ((seen == 0) + (n15_12 == __frame.sym0)) + n15_12].n[1];
            __frame.sym1 = rc.decode_bit(
                     n0,
                     __frame.sym5->run_ctr[16 * ((seen == 0) + (n15_12 == __frame.sym0)) + n15_12].n[1]);
            if ( __frame.sym5->run_ctr[16 * ((seen == 0) + (n15_12 == __frame.sym0)) + n15_12].limit < (uint32_t)bin_tot )
...
LABEL_57:
      if ( n15_18 > n15_14 )
      {
        ...
        r8b = _this->row_cur[8];
        r7b = _this->row_cur[7] + n15_18;
        _this->row_cur[7] = r7b - n15_14;
        _this->row_cur[8] = r8b + n15_18 - n15_14;
        rec = _this->row_cur[5];
        ...
        *(uint32_t *)_this->row_cur[5] = 0x01010101;
        ...
        if ( n15_18 - n15_14 != 1 )
        {
          ...
          if ( n15_18 - n15_14 - 1 > (uint32_t)(done - 1) )
          {
            n15_15 = __frame.sym3;
        ...
        g_a = n15_16[-3].match[0];
        g_b = n15_16[-2].match[0];
        g_c = n15_16[2].match[0];
        g_d = n15_16[3].match[0];
        __frame.sym0 = (int32_t)n15_16;
        g_ab = g_b + g_a;
        g_e = n15_16[4].match[0];
        ...
        _this->grad[3] = next[-5].match[0]
                                     ...
                                     + next[-4].match[0]
                                     - 4;
        next[-1].match[4] = n4_17 == n15_17[1].sym;
        n15_18 = n15_24;
  ...
  if ( freq_tbl->w[5] )
  {
    if ( tot == 1 )
    {
      ...
      *freq_tbl = *freq;
      ...
      n3 = (w3r + w5 - 1) / w5 + n15_21;
      w4r = 21 * freq_tbl->w[4];
      freq_tbl->w[3] = n3;
      n4r = (w4r + w5 - 1) / w5 + __frame.sym3;
      freq_tbl->w[4] = n4r;
      tot2 = __frame.sym1 + n4r + (n3 + (uint16_t)(uintptr_t)n2r + n1);
      tot = tot2;
      freq_tbl->w[5] = tot2;
    }
    arg_tot = tot;
  ...
  else
  {
    ...
    arg_high = cum2;
    arg_cum = cum2 - __frame.sym4->w[n4_2];
...
LABEL_86:
  ...
  exclusion_mask[n15_23] = gen;
  exclusion_mask[n4_20] = gen;
  exclusion_mask[n4_19] = gen;
  __byte_445440[0] = gen;
  _this->sel[0] = nullptr;
  n4_5 = pixr[1];
  __frame.sym0 = *pixr;
...
int32_t __code_pixel(ModelBlock *_this, int32_t a2)
{
  ...
  ;
  PixRec *r4;
  PixRec *r1, *r2, *n2_9, *r3, *r5;   // row cursors out of ModelBlock
  uint8_t *alpha_map;
  FreqRec *n15_36, *n15_38;
  ...
  PixRec *n2_8, *n2_11, *n2_12, *r6, *r7;   // row cursors out of ModelBlock
  uint16_t *n2_14, *wq, *sym_cache, *n2_6, w6;
  ...
  *(int32_t *)&_this->f36 = ctx_state;
  ...
  ctx_bucket = _this->ctx_bucket[ctx_state + n15_5];
  r2 = _this->row_cur[7];
...
LABEL_42:
    ...
    if ( n15_12 > n15_9 )
    {
      _this->row_cur[6] = &p_n15_3[n15_12 - n15_9];
      _this->row_cur[7] = &up2[n15_12 - n15_9];
      row_cur9 = (int32_t)_this->row_cur[9];
      _this->row_cur[8] = _this->row_cur[8] + n15_12 - n15_9;
      wp = (uint16_t *)__frame.sym9;
      _this->row_cur[9] = (PixRec *)row_cur9 + n15_12 - n15_9;
      ...
      *(uint32_t *)_this->row_cur[5] = 0x01010101;
      ...
      _this->grad[1] = up3[3].match[0]
                                   ...
                                   + up3[4].match[0]
                                   - 8;
      _this->grad[2] = n2_13[-4].match[1] + n2_13[-3].match[1] - 2;
      n15_11 = __frame.sym8;
      _this->grad[3] = n2_13[-5].match[0]
                                   + n2_13[-6].match[0]
                                   + n2_13[-7].match[0]
                                   + n2_13[-4].match[0]
                                   - 4;
      n2_13[-1].match[4] = n15_11 == r4[1].sym;
      n15_32 = __frame.sym3;
      _this->row_cur[5][-1].match[5] = n15_11 == _this->row_cur[6][2].sym;
      n15_12 = n15_14;
    }
    __encode_context_bit(&_this->esc_ctr[(n15_32 + 1)], _this->esc_ctr, __frame.sym6);
    n15_13 = __frame.sym6;
    n4_2 = ::mode_symbol[1];
  ...
  else
  {
    ...
    else
    {
      ...
      n15_36->w[n2_2] += n15_21;
      rc.encode(arg_cum, arg_high, arg_tot);
      *(int32_t *)&_this->hit = n2_2;
  ...
  do
  {
    ...
    do
    {
      ...
      do
      {
        ...
        this_1->ctx_bucket[g + 15 * lo + 75 * n5] = g1;
        m5 = this_3->alphabet;
      ...
      if ( !alphabet_reduced )
      {
              ...
              v87) )
        {
          ...
          *(uint16_t *)&v527[1].w2 += (uint32_t)(v550 - p2_pred(v527[1].w2, v527[1].b0) + 2) >> 2;
          v350 = v555->w2;
          v548 = -v349;
          v351 = -v349 - p2_pred(v350, v555->b0);
        ...
        else
        {
          ...
          if ( v87 )
          {
            ...
            *(uint16_t *)&v524[1].w2 += (uint32_t)(v268
            ...
            v279 = v560->w2;
            v280 = v277 - p2_pred(v279, v560->b0);
          ...
          else
          {
            ...
            v183 = v560->w2;
            v184 = v181 - p2_pred(v183, v560->b0);
...
LABEL_37:
        ...
        v399 = a1->ctx_w[2].sel;
        v400 = a1->ctx_w[0].w[1] + (a1->ctx & 0x3F);
        v510 = v398;
...
LABEL_48:
        ...
        if ( !a1->plane_idx || a1->freq[a1->ctx].step > 0x100u )
        {
          ...
          if ( v410 == 1 )
          {
            ...
            v492 = a1->freq[a1->ctx_w[0].w[0] + n0x10 - a1->ctx_w[0].w[1]].f[0];
            v493 = a1->freq[a1->ctx_w[0].w[0] + n0x10 - a1->ctx_w[0].w[1]].f[1];
            v508 = (uintptr_t)v491;
          ...
          if ( v419 == 1 )
          {
            ...
            v481 = a1->freq[a1->ctx_w[1].w[0] + n0x10 - a1->ctx_w[1].w[1]].f[0];
            v482 = a1->freq[a1->ctx_w[1].w[0] + n0x10 - a1->ctx_w[1].w[1]].f[1];
            n2 = (uint16_t *)n2_4;
          ...
          if ( v427 == 1 )
          {
            ...
            v470 = a1->freq[a1->ctx_w[2].w[0] + n0x10 - a1->ctx_w[2].w[1]].f[0];
            v471 = a1->freq[a1->ctx_w[2].w[0] + n0x10 - a1->ctx_w[2].w[1]].f[1];
            n2 = (uint16_t *)n2_5;
          ...
          if ( v435 == 1 )
          {
            ...
            v459 = a1->freq[a1->ctx_w[3].w[0] + n0x10 - a1->ctx_w[3].w[1]].f[0];
            v460 = a1->freq[a1->ctx_w[3].w[0] + n0x10 - a1->ctx_w[3].w[1]].f[1];
            n2 = (uint16_t *)n2_6;
          ...
          if ( v443 == 1 )
          {
            ...
            v447 = a1->freq[a1->ctx_w[4].w[0] + n0x10 - a1->ctx_w[4].w[1]].f[0];
            v448 = a1->freq[a1->ctx_w[4].w[0] + n0x10 - a1->ctx_w[4].w[1]].f[1];
            v449 = n2_7->f[2];
            n2 = (uint16_t *)n2_7;
...
uint32_t __search_filter(BmfImage *img, int8_t a2)
{
  ...
  int8_t f4;
  uint8_t f0, f1, f2, f3;
  uint8_t *srcp, *y, *dstp, *n4_13, *Blockb_2, *Srca_1, *n4_14, *p0, *p1, *n4_17, *p2, *p3, *Blockb_6, *p4, *p5, *p6, *Blockb_7, *p7, *p10, *p11, *Blockb_8, *p12, *p13, *p14, *Blockb_9, *Blockb_4, *Srca_3, *Blockb_5, *Srca_4, *n0x7FFFFFFF_5, *Srca_5, *Blockb_3, *Srca_2, *Blockb_1, *Srca, *n5_6;   // `uint8_t *` beside the `char` scalars above
  ...
  __frame.Blockb = (uint8_t *)__alloc_image(tile_w, tile_h, img_c->depth & 0x3F, 0, 0);
  ...
  hist_scratch = coded_buf + coded_size - 4096;
  __frame.Srca_7 = bmf_new(tile_h * tile_w);
  n4_4 = ::plane_count;
  ...
  __frame.rows[0] = __frame.Blockb + 16;
  if ( y0 < tile_h + y0 )
  {
  ...
  if ( n4_4 > 0 )
  {
    ...
    while ( 1 )
    {
      ...
      else
      {
        ...
        __model_planes(Blockb_1, Srca, pl1, 0);
      ...
      __model_planes(Blockb_2, Srca_1, __frame.dims[1], 0);
      ...
      *(uint32_t *)packer_word = packer_acc;
      ...
      if ( n0x7FFFFFFF_2 < n0x7FFFFFFF + (n0x7FFFFFFF >> 5) || n4_13 )
      {
        ...
        __model_planes(Blockb_3, Srca_2, pl0, 0);
...
LABEL_191:
          ...
          *(uint32_t *)packer_word = packer_acc;
          ...
          if ( n2 == 2 || n0x7FFFFFFF + (n0x7FFFFFFF >> 5) > (int32_t)__frame.rows[0] )
          {
            ...
            deep2 = n0x7FFFFFFF_6 < n0x7FFFFFFF;
...
LABEL_172:
  ...
  if ( ::plane_count > 2 )
  {
    if ( __frame.bits_total )
    {
      ...
      do
      {
        __frame.dims[n16 + 1] = plane_desc[n16 / 4].w12;
        __frame.dims[n16] = *(int32_t *)((uint8_t *)&::plane_count + n16 * 4);
        __frame.rows[n16 + 1] = (uint8_t *)plane_desc[n16 / 4].w4;
        p1 = (uint8_t *)plane_desc[n16 / 4].w0;
        __frame.rows[n16] = p1;
        n16 -= 4;
      }
      while ( n16 * 4 );
      ...
      __transform_planes((BmfImage *)(uint16_t *)__frame.Blockb, (int32_t)p1, 0);
      n4_20 = 8 * (out_cursor - coded_buf);
      // never taken: -S
      deep2 = n4_20 <= (int32_t)__frame.n4_15;
      *(uint32_t *)packer_word = packer_acc;
      packer_free_bits = 0;
      packer_acc = 0;
      out_cursor = coded_buf;
      ...
      else
      {
        ...
        do
        {
          *(uint64_t *)(bmf_plane_desc(n64 - 8)) = *(uint64_t *)&__frame.dims[n64 / 4];
          *(uint64_t *)(bmf_plane_desc(n64 - 16)) = *(uint64_t *)&__frame.rows[n64 / 4];
          *(uint64_t *)(bmf_plane_desc(n64 - 24)) = (*(uint64_t (*)[2])((uint8_t *)__frame.marks))[n64 / 8 + 1];
          *(uint64_t *)(bmf_plane_desc(n64 - 32)) = (*(uint64_t (*)[2])((uint8_t *)__frame.marks))[n64 / 8];
          n64 -= 32;
        }
        while ( n64 );
        n4_6 = ::plane_count;
    ...
    if ( &__frame.n4_10[cand == 0] )
    {
      n16_1 = 16;
      do
      {
        __frame.dims[n16_1 + 1] = plane_desc[n16_1 / 4].w12;
        __frame.dims[n16_1] = *(int32_t *)((uint8_t *)&::plane_count + n16_1 * 4);
        __frame.rows[n16_1 + 1] = (uint8_t *)plane_desc[n16_1 / 4].w4;
        __frame.rows[n16_1] = (uint8_t *)plane_desc[n16_1 / 4].w0;
        n16_1 -= 4;
      }
      while ( n16_1 * 4 );
      n4_7 = ::plane_count;
      ...
      {
        __transform_planes((BmfImage *)(uint16_t *)__frame.Blockb, cand, 0);
        n4_14 = (uint8_t *)(8 * (out_cursor - coded_buf));
        // never taken: -S
        deep2 = (int32_t)n4_14 <= (int32_t)__frame.n4_15;
        __frame.rows[0] = n4_14;
        *(uint32_t *)packer_word = packer_acc;
        packer_free_bits = 0;
        packer_acc = 0;
        out_cursor = coded_buf;
        ...
        if ( deep2 )
        {
          ...
          else
          {
            ...
            do
            {
              __frame.dims[n16_2 + 1] = plane_desc[n16_2 / 4].w12;
              __frame.dims[n16_2] = *(int32_t *)((uint8_t *)&::plane_count + n16_2 * 4);
              __frame.rows[n16_2 + 1] = (uint8_t *)plane_desc[n16_2 / 4].w4;
              p0 = (uint8_t *)plane_desc[n16_2 / 4].w0;
              __frame.rows[n16_2] = p0;
              n16_2 -= 4;
            }
            while ( n16_2 * 4 );
            if ( ::plane_count > 0 )
            ...
            *(uint32_t *)packer_word = packer_acc;
            ...
            else
            {
              ...
              do
              {
                *(uint64_t *)(bmf_plane_desc(n64_1 - 8)) = *(uint64_t *)&__frame.dims[n64_1 / 4];
                *(uint64_t *)(bmf_plane_desc(n64_1 - 16)) = *(uint64_t *)&__frame.rows[n64_1 / 4];
                *(uint64_t *)(bmf_plane_desc(n64_1 - 24)) = (*(uint64_t (*)[2])((uint8_t *)__frame.marks))[n64_1 / 8 + 1];
                *(uint64_t *)(bmf_plane_desc(n64_1 - 32)) = (*(uint64_t (*)[2])((uint8_t *)__frame.marks))[n64_1 / 8];
                n64_1 -= 32;
              }
              while ( n64_1 );
              cand = 0;
        ...
        else
        {
          ...
          do
          {
            *(uint64_t *)(bmf_plane_desc(n64_2 - 8)) = *(uint64_t *)&__frame.dims[n64_2 / 4];
            *(uint64_t *)(bmf_plane_desc(n64_2 - 16)) = *(uint64_t *)&__frame.rows[n64_2 / 4];
            *(uint64_t *)(bmf_plane_desc(n64_2 - 24)) = (*(uint64_t (*)[2])((uint8_t *)__frame.marks))[n64_2 / 8 + 1];
            *(uint64_t *)(bmf_plane_desc(n64_2 - 32)) = (*(uint64_t (*)[2])((uint8_t *)__frame.marks))[n64_2 / 8];
            n64_2 -= 32;
          }
          while ( n64_2 );
        }
...
LABEL_63:
  if ( !__frame.n4_10 && ::plane_count > 1 )
  {
    ...
    do
    {
      __frame.dims[n16_3 + 1] = plane_desc[n16_3 / 4].w12;
      __frame.dims[n16_3] = *(int32_t *)((uint8_t *)&::plane_count + n16_3 * 4);
      __frame.rows[n16_3 + 1] = (uint8_t *)plane_desc[n16_3 / 4].w4;
      __frame.rows[n16_3] = (uint8_t *)plane_desc[n16_3 / 4].w0;
      n16_3 -= 4;
    }
    while ( n16_3 * 4 );
    if ( ::plane_count > 0 )
    ...
    *(uint32_t *)packer_word = packer_acc;
    ...
    if ( (int32_t)n4_17 > (int32_t)__frame.n4_15 )
    {
      ...
      do
      {
        *(uint64_t *)(bmf_plane_desc(n64_3 - 8)) = *(uint64_t *)&__frame.dims[n64_3 / 4];
        *(uint64_t *)(bmf_plane_desc(n64_3 - 16)) = *(uint64_t *)&__frame.rows[n64_3 / 4];
        *(uint64_t *)(bmf_plane_desc(n64_3 - 24)) = (*(uint64_t (*)[2])((uint8_t *)__frame.marks))[n64_3 / 8 + 1];
        *(uint64_t *)(bmf_plane_desc(n64_3 - 32)) = (*(uint64_t (*)[2])((uint8_t *)__frame.marks))[n64_3 / 8];
        n64_3 -= 32;
      }
      while ( n64_3 );
    }
    ...
    if ( __frame.n_flagged + __frame.bits_total )                // the left disjunct is -S, always true
    {
      ...
      do
      {
        __frame.dims[n16_4 + 1] = plane_desc[n16_4 / 4].w12;
        __frame.dims[n16_4] = *(int32_t *)((uint8_t *)&::plane_count + n16_4 * 4);
        __frame.rows[n16_4 + 1] = (uint8_t *)plane_desc[n16_4 / 4].w4;
        __frame.rows[n16_4] = (uint8_t *)plane_desc[n16_4 / 4].w0;
        n16_4 -= 4;
      }
      while ( n16_4 * 4 );
      if ( ::plane_count > 0 )
      ...
      memcpy((uint8_t *)__frame.Src,__frame.rows[0],*((uint32_t *)__frame.Blockb + 3));
      __transform_planes((BmfImage *)(uint16_t *)__frame.Blockb, cand, 0);
      n4_18 = 8 * (out_cursor - coded_buf);
      // never taken: -S
      deep2 = n4_18 <= (int32_t)__frame.n4_15;
      *(uint32_t *)packer_word = packer_acc;
      packer_free_bits = 0;
      packer_acc = 0;
      out_cursor = coded_buf;
      ...
      else
      {
        ...
        do
        {
          *(uint64_t *)(bmf_plane_desc(n64_4 - 8)) = *(uint64_t *)&__frame.dims[n64_4 / 4];
          *(uint64_t *)(bmf_plane_desc(n64_4 - 16)) = *(uint64_t *)&__frame.rows[n64_4 / 4];
          *(uint64_t *)(bmf_plane_desc(n64_4 - 24)) = (*(uint64_t (*)[2])((uint8_t *)__frame.marks))[n64_4 / 8 + 1];
          *(uint64_t *)(bmf_plane_desc(n64_4 - 32)) = (*(uint64_t (*)[2])((uint8_t *)__frame.marks))[n64_4 / 8];
          n64_4 -= 32;
        }
        while ( n64_4 );
      }
