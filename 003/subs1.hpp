...
LABEL_37:
        ...
        ((uint16_t *)n2)[v510 + 1] += (uint16_t)(p2_rec[470032] & 0xFFFC) >> 2;
LABEL_48:
        if ( a4 )
        {
          n2_half = (a4 - 1) >> 1;
...
LABEL_103:
          ...
          if ( v443 == 1 )
          {
            ...
            n2 = (uint8_t *)&p2_rec[470040];
            if ( v453 + v454 > 29696 )
              __rescale_three_way(&p2_rec[470040]);
            n0xF0_5 = (uint16_t *)(n0xF0);
            ((uint16_t *)n2)[v511 + 1] += (uint16_t)(p2_rec[470040] & 0xFFFC) >> 2;
