...
int32_t __symbol_list_update(Obj6 *_this, int32_t a2, uint32_t a3)
{
  ;
...
LABEL_16:
    ...
    if ( n251 > 251 || v21 < *((uint32_t *)_this + 3) )
    {
...
static inline int32_t __fwd_init_model_tables_symbol_list_update(void *a0, int32_t a1, uint32_t a2) { return __symbol_list_update((Obj6 *)a0, a1, a2); }
...
void __alt_model_p1_d8_encode(uint8_t *a1, int32_t i, int32_t a3, uint8_t *a4)
{
  ...
  if ( v4 )
    ...
    v5 = nullptr;
  __fwd_alt_model_p1_d8_encode_alt_p1_d8_encode_body((int32_t)v5, a1, a4);
  if ( v5 )
...
int32_t __choose_plane_coding(Obj97 *a1, int32_t n3, char a3)
{
  ...
  if ( n4 > 0 )
  {
    ...
    if ( n4 >= 3 )
    {
      v15 = __fwd_choose_plane_coding_cost_candidate(v226, nullptr, (int32_t)v217, v7, v174, v175, v176, (int32_t)&v214[2]);
      v17 = __fwd_choose_plane_coding_cost_candidate(v226, (uint8_t *)1, (int32_t)v218, v16, v174, v175, v176, (int32_t)&v214[2]);
      v19 = v17 >= v15;
      if ( v17 >= v15 )
        v17 = v15;
      n2_3 = !v19;
      ...
      v21 = 0;
      n2_4 = __fwd_choose_plane_coding_cost_candidate(v226, (uint8_t *)2, (int32_t)v219, v18, v174, v175, v176, (int32_t)&v214[2]) < v17;
      n2 = n2_3;
      if ( n2_4 )
        n2 = 2;
      v205.m128_i32[2] = n2;
      ...
      LODWORD(v209) = (uint8_t)__byte_44339D[0] - v205.m128_i32[2];
      n128_1 = __dword_4433A4[4 * v205.m128_i32[2]];
      HIDWORD(v208) = (uint8_t)__byte_4433AD[0] - v205.m128_i32[2];
      n128 = __dword_4433A0[4 * v205.m128_i32[2]];
...
LABEL_19:
      ...
      *(int32_t *)((char *)__dword_4433A4 + v43) = n128_1;
      ...
      n192 = n255 + 1;
      __byte_44339F[16 * HIDWORD(v208) + v205.m128_i32[1]] = n192;
      if ( n4 >= 4 )
      {
        v202 = v21;
        v203 = v21;
...
LABEL_57:
      ...
      {
        v53 = this_3->f84;
        this_3->f80 = this_3->f80 + 8 * n15_18 - 8 * n15_14;
        v54 = this_3->f88;
        v55 = v53 + 8 * n15_18;
        v56 = this_3->f92;
        this_3->f84 = v55 - 8 * n15_14;
        this_3->f88 = v54 + 8 * n15_18 - 8 * n15_14;
        v57 = this_3->f76;
  ...
  if ( n4 )
  {
    *(uint16_t *)this_3->f76 = __dword_44573C[n4];
    return 1;
  }
  n15_18 = 0;
LABEL_86:
...
LABEL_42:
  ...
  else
  {
    ...
    n15_36 = (int32_t)&((int32_t *)this_3)[v82 + 24];
    n15_31 = n15_36;
...
void __expand_alphabet(Obj10 *_this)
{
...
void __alt_model_p2_d8_decode(const __m128 &a1__ref, const __m128 &a2__ref, uint8_t *Src, int32_t i, int32_t a5)
{
  ...
  if ( v5 )
    lpAddress = (void **)__alt_p2_alloc((int32_t)v5, i, 0);
  else
    lpAddress = nullptr;
...
static inline int32_t __fwd_alt_model_p2_decode_alt_p2_decode_symbol(void *a0, int32_t a1) { return __alt_p2_decode_symbol((Obj13 *)a0, a1); }
...
int32_t __alt_model_p2_decode(uint16_t *p_i, uint8_t *Src)
{
  ...
  if ( plane_count > 0 )
  {
    ...
    do
    {
      ...
      if ( v7 )
        v8 = (void *)__alt_p2_alloc((int32_t)v7, i, n4);
      else
        v8 = nullptr;
      *(&lpAddress + n4++) = v8;
    }
    ...
    do
    {
      ...
      if ( i > 0 )
      {
        ...
        do
        {
          ...
          v168 = v101;
          v103 = __fwd_alt_model_p2_decode_alt_p2_decode_symbol(v102, (int32_t)((uint32_t *)lpAddress_1 + 69677));
          v104 = (uint8_t)(v168 + *((uint8_t *)lpAddress_1 + v103 + 280496));
          __alt_p2_model((int32_t)lpAddress_1, __xmmword_439B60, v104, v103, v104 - v168);
          ...
          *(uint16_t *)(v156->f278528[13].m128_i32[0] + 2) = v110;
          ...
          v113 = __fwd_alt_model_p2_decode_alt_p2_decode_symbol(&v111->f940064.m128_u16[4 * v111->f278528[11].m128_i32[0] + 4], (int32_t)&v111->f278528[11].m128_i32[1]);
          v114 = (uint8_t)(v112 + v111->f280496.m128_i8[v113]);
          v169 = v114;
          __alt_p2_model((int32_t)v111, __xmmword_439B60, v114, v113, v114 - v112);
          ...
          *(uint16_t *)(v157->f278528[13].m128_i32[0] + 2) = v119;
          ...
          v122 = __fwd_alt_model_p2_decode_alt_p2_decode_symbol(&v120->f940064.m128_u16[4 * v120->f278528[11].m128_i32[0] + 4], (int32_t)&v120->f278528[11].m128_i32[1]);
          v123 = (uint8_t)(v121 + v120->f280496.m128_i8[v122]);
          v170 = v123;
          __alt_p2_model((int32_t)v120, __xmmword_439B60, v123, v122, v123 - v121);
          ...
          if ( plane_count >= 4 )
          {
            ...
            *(uint16_t *)(v158->f278528[13].m128_i32[0] + 2) = v128;
            ...
            v131 = __fwd_alt_model_p2_decode_alt_p2_decode_symbol(&v129->f940064.m128_u16[4 * v129->f278528[11].m128_i32[0] + 4], (int32_t)&v129->f278528[11].m128_i32[1]);
            v154 = (uint8_t)(v130 + v129->f280496.m128_i8[v131]);
            __alt_p2_model((int32_t)v129, __xmmword_439B60, v154, v131, v154 - v130);
...
void __alt_p2_d8_encode_body(Obj11 *lpAddress, const __m128 &a2__ref, const __m128 &a3__ref, uint8_t *a4, int32_t i, int32_t a6, uint8_t *a7)
{
  ...
  if ( i > 0 )
  {
    ...
    for ( j = 0; j < i; ++j )
    {
      ...
      __fwd_alt_p2_d8_encode_body_alt_p2_encode_symbol(
        ...
        (int32_t)&lpAddress->f278528[11].m128_i32[1],
        v104);
      ++v103;
      LOWORD(v16) = 16 * (uint8_t)*a7;
      *(uint16_t *)lpAddress->f278528[13].m128_i32[0] = v16;
      ...
      *(uint8_t *)(lpAddress->f278528[13].m128_i32[0] + 16) = (*(int16_t *)(lpAddress->f278528[13].m128_i32[0] + 4) <= 0)
      ...
      lpAddress->f278528[13].m128_i32[0] = v11;
    }
    v8 = v103;
  }
  bmf_copy((void *)(v11), (const void *)((uintptr_t)v11 - 18), 18);
  v23 = lpAddress->f278528[13].m128_i32[0];
  v24 = *(uint32_t *)(v23 - 10);
  v25 = *(uint32_t *)(v23 - 6);
  ...
  *(uint16_t *)(v23 + 34) = v26;
  ...
  v30 = lpAddress->f278528[13].m128_i32[0];
  v31 = *(uint32_t *)(v30 - 14);
  v32 = *(uint32_t *)(v30 - 10);
  ...
  *(uint16_t *)(v30 + 70) = v31;
  ...
  v38 = lpAddress->f278528[13].m128_i32[0];
  v39 = -18 * i;
  ...
  *(uint16_t *)(v38 + v39 - 2) = *(uint16_t *)(v38 + v39 + 16);
  v40 = lpAddress->f278528[13].m128_i32[0];
  ...
  *(uint16_t *)(v40 + v39 - 20) = *(uint16_t *)(v40 + v39 + 34);
  v41 = lpAddress->f278528[13].m128_i32[0];
  ...
  *(uint16_t *)(v41 + v39 - 38) = *(uint16_t *)(v41 + v39 + 52);
  v42 = lpAddress->f278528[13].m128_i32[0];
  ...
  *(uint16_t *)(v42 + v39 - 56) = *(uint16_t *)(v42 + v39 + 70);
  v43 = lpAddress->f278528[13].m128_i32[0];
  ...
  *(uint16_t *)(v43 + v39 - 74) = *(uint16_t *)(v43 + v39 + 88);
  v44 = lpAddress->f278528[13].m128_i32[0];
  ...
  *(uint16_t *)(v44 + v39 - 92) = *(uint16_t *)(v44 + v39 + 106);
  v45 = lpAddress->f278528[13].m128_i32[0];
  ...
  *(uint16_t *)(v45 + v39 - 110) = *(uint16_t *)(v45 + v39 + 124);
  v46 = lpAddress->f278528[13].m128_i32[0];
  ...
  *(uint16_t *)(v46 + v39 - 128) = *(uint16_t *)(v46 + v39 + 142);
  ...
  if ( a6 > 1 )
  {
    v106 = &lpAddress->f278528[11].m128_i8[4];
    v105 = a7;
    v50 = 0;
    v102 = 0;
    do
    {
      v51 = lpAddress->f278528[8].m128_i32[3];
      v52 = *(uint32_t *)(v51 - 4);
      v109 = v8;
      *(uint32_t *)(v51 + 4) = v52;
      ...
      *(uint32_t *)(lpAddress->f278528[8].m128_i32[3] - 8) = v55;
      ...
      v61 = lpAddress->f278528[13].m128_i32[0];
      v62 = *(uint32_t *)(v61 - 32);
      v63 = *(uint32_t *)(v61 - 28);
      ...
      *(uint16_t *)(v61 + 34) = (uint16_t)v53;
      ...
      v69 = lpAddress->f278528[13].m128_i32[0];
      v70 = *(uint32_t *)(v69 - 64);
      v71 = *(uint32_t *)(v69 - 60);
      ...
      *(uint16_t *)(v69 + 70) = (uint16_t)v53;
      ...
      v79 = lpAddress->f278528[14].m128_i32[1];
      ...
      lpAddress->f278528[14].m128_i32[2] = v79;
      v76 += 144;
      lpAddress->f278528[13].m128_i32[0] = v76;
      v79 += 144;
      lpAddress->f278528[13].m128_i32[1] = v79;
      ...
      *(uint16_t *)(lpAddress->f278528[13].m128_i32[0] + 2) = 0;
      if ( i > 0 )
      {
        ...
        for ( k = 0; k < i; ++k )
        {
          ...
          v110 = v99;
          __fwd_alt_p2_d8_encode_body_alt_p2_encode_symbol(&lpAddress_1->f940064.m128_u16[4 * lpAddress_1->f278528[11].m128_i32[0] + 4], (int32_t)v106, v99);
          __alt_p2_model((int32_t)lpAddress_1, a3, (uint8_t)v105[k], v110, (uint8_t)v105[k] - v95);
          v8 = &v109[k + 1];
...
void __alt_model_p2_d8_encode(const __m128 &a1__ref, const __m128 &a2__ref, uint8_t *a3, int32_t i, int32_t a5, uint8_t *a6)
{
  ...
  if ( v6 )
    lpAddress = (Obj11 *)((__m128 *)__alt_p2_alloc((int32_t)v6, i, 0));
  else
...
static inline int32_t __fwd_alt_model_p2_encode_alt_p2_encode_symbol(void *a0, int32_t a1, int32_t a2) { return __alt_p2_encode_symbol((Obj7 *)a0, a1, a2); }
...
int32_t __alt_model_p2_encode(BmfImage *p_i, uint8_t *a2)
{
  ...
  if ( plane_count > 0 )
  {
    ...
    do
    {
      v7 = bmf_page_alloc(0x103E30u);
      if ( v7 )
        v8 = (void *)__alt_p2_alloc((int32_t)v7, i_1, n4);
      else
        v8 = nullptr;
      *(&lpAddress + n4++) = v8;
    }
      ...
      else
      {
        ...
        for ( i = 0; i < i_2; ++i )
        {
          ...
          __fwd_alt_model_p2_encode_alt_p2_encode_symbol(
            ...
            v105);
          __alt_p2_model((int32_t)lpAddress_1, __xmmword_439B50, v104, v105, v104 - v178);
          ...
          *(uint16_t *)(v160->f278528[13].m128_i32[0] + 2) = v113;
          ...
          __fwd_alt_model_p2_encode_alt_p2_encode_symbol(&v114->f940064.m128_u16[4 * v114->f278528[11].m128_i32[0] + 4], (int32_t)&v114->f278528[11].m128_i32[1], v116);
          __alt_p2_model((int32_t)v114, __xmmword_439B50, v115, v116, v115 - v179);
          ...
          *(uint16_t *)(v161->f278528[13].m128_i32[0] + 2) = v124;
          ...
          __fwd_alt_model_p2_encode_alt_p2_encode_symbol(&v125->f940064.m128_u16[4 * v125->f278528[11].m128_i32[0] + 4], (int32_t)&v125->f278528[11].m128_i32[1], v127);
          __alt_p2_model((int32_t)v125, __xmmword_439B50, v126, v127, v126 - v180);
          ...
          if ( plane_count >= 4 )
          {
            ...
            *(uint16_t *)(v162->f278528[13].m128_i32[0] + 2) = v132;
            ...
            __fwd_alt_model_p2_encode_alt_p2_encode_symbol(&v133->f940064.m128_u16[4 * v133->f278528[11].m128_i32[0] + 4], (int32_t)&v133->f278528[11].m128_i32[1], v135);
            __alt_p2_model((int32_t)v133, __xmmword_439B50, v134, v135, v134 - v157);
...
void __model_planes(char *Blockb, char *Srca_3, int32_t a3, char a4, const __m128 &a5__ref, const __m128 &a6__ref)
{
  ...
  __m128 a5 = a5__ref;
  __m128 a6 = a6__ref;
  char *Srca_1, v8, *Srca_2, *__model_planes_buf;
    ...
    if ( ::plane_count > 0 )
    {
      ...
      do
      {
        ...
        if ( ::plane_predictor )
        {
          ...
          {
            if ( !plane_alt_model )
              __unpredict_med((int32_t)Src_1, *(uint16_t *)p_i_1, *((uint16_t *)p_i_1 + 1));
          }
...
LABEL_22:
  ...
  if ( ElementCount )
  {
    ...
    if ( ::plane_count > 0 )
    {
      ...
      n4_1 = 0;
      do
        __fwd_compress_image_model_planes((char *)p_i, Srca, (uint8_t)__byte_44339D[16 * n4_1++], v36, a2, a3);
      while ( n4_1 < ::plane_count );
      v5 = v66;
    }
    free(Srca);
