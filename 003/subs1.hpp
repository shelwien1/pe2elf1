...
struct PlaneDesc {
  union {
    ...
    struct {
      ...
      uint8_t src_plane;   // a plane number, fed back as `plane_desc[b1 + 1]`
...
struct Obj0 {
  ...
  int32_t f4;
  int32_t f8;
  union {   // the same bytes, 2 recoveries
...
static_assert(sizeof(void *) != 4
              || __builtin_offsetof(Obj0, f12) == 12,
...
char *__alt_p2_alloc(Obj11 *_this, int32_t i, int32_t n4)
{
  ...
  *(uint32_t *)((char *)_this + 278732) = (uint8_t)(plane_desc[(uint8_t)plane_desc[_this->f278728 + 1].src_plane + 1].flags
                                               & 8) >> 3;
  deadzone_hi = v8;
  deadzone_lo = -v8;
...
char * __interleave_plane(char *p_i, char *Src, int32_t a3, char a4)
{
  ...
  v29 = (uint8_t)plane_desc[1].src_plane - a3;
  v31 = (uint8_t)plane_desc[2].src_plane - a3;
  n2 = (uint8_t)plane_desc[a3 + 1].predictor;
...
LABEL_3:
  ...
  v29 = (uint8_t)plane_desc[2].src_plane - a3;
LABEL_4:
  p_i += a3;
  v25 = &p_i[v29];
  if ( n6 <= 6 )
...
LABEL_31:
  ...
  v33 = (uint8_t)plane_desc[1].src_plane - a3;
  v35 = (uint8_t)plane_desc[2].src_plane - a3;
  n2 = (uint8_t)plane_desc[a3 + 1].predictor;
  ...
  if ( n2 == 2 && v36 + v4 == 128 )
  {
    ...
    if ( !v36 )
    {
      v33 = (uint8_t)plane_desc[2].src_plane - a3;
      goto LABEL_4;
    }
  }
  if ( plane_desc[a3 + 1].predictor == 1 )
      ...
      if ( i_3 > 0 )
      {
        ...
        do
        {
          ...
          *(uint8_t *)(v51[49] + 1) = abs32(v56 - v54);
          ...
          v51[53] += 2;
          v59 = (Obj0 *)v94;
          *(uint8_t *)((uint8_t)plane_desc[1].src_plane + Src) = v58;
          ...
          *(uint8_t *)(v59->f12[46] + 1) = abs32(v64 - v62);
          ...
          v59->f12[50] += 2;
          if ( v101 )
            v104 += v97 + *(uint8_t *)((uint8_t)plane_desc[1].src_plane + Src);
          v66 = (Obj0 *)(v95);
          v84 = Block_plane[0];
          v83 = v94;
          *(uint8_t *)(Src + (uint8_t)plane_desc[2].src_plane) = v104;
          ...
          *v70 = v71;
          ...
          ((uint8_t**)v66)[v66->f12[2] + 6] = &((uint8_t**)v66)[v66->f12[2] + 6][v66->f196[1]
                                                           - *(v66->f196 - 7)
                                                           - (*(v66->f212 - 3)
                                                            - v66->f212[13])
                                                           - (*(v66->f204 - 3)
          ...
          v66->f212 += 2;
          if ( ArgList_1 )
            *(uint8_t *)((uint8_t)plane_desc[3].src_plane + Src) = ((plane_desc[(uint8_t)plane_desc[3].src_plane + 1].w4
                                                                * *(uint8_t *)((uint8_t)plane_desc[1].src_plane
                                                                                     + Src)
                                                                + plane_desc[(uint8_t)plane_desc[3].src_plane + 1].w8
                                                                * (uint32_t)*(uint8_t *)((uint8_t)plane_desc[2].src_plane + Src)
                                                                + 40) >> 7)
                                                              + v98
                                                              + v105;
          else
            *(uint8_t *)((uint8_t)plane_desc[3].src_plane + Src) = v105;
          n4_1 = plane_count;
          if ( plane_count >= 4 )
          {
            v73 = (Obj0 *)(v96);
            ...
            *v77 = v78;
            ...
            ((uint8_t**)v73)[v73->f12[2] + 6] = &((uint8_t**)v73)[v73->f12[2] + 6][v73->f196[1]
                                                             - *(v73->f196 - 7)
                                                             - (*(v73->f212 - 3)
                                                              - v73->f212[13])
                                                             - (*(v73->f204 - 3)
...
int32_t __choose_plane_coding(Obj97 *a1, int32_t n3, char a3)
{
  ...
  if ( n4 > 0 )
  {
    ...
    if ( n4 >= 3 )
    {
      ...
      LODWORD(v209) = (uint8_t)plane_desc[1].src_plane - v205.m128_i32[2];
      n128_1 = plane_desc[v205.m128_i32[2] + 1].w8;
      HIDWORD(v208) = (uint8_t)plane_desc[2].src_plane - v205.m128_i32[2];
    ...
    do
    {
      ...
      if ( i_3 > 0 )
      {
        ...
        do
        {
          ...
          n5_9 = *(uint8_t *)(a2 + (uint8_t)plane_desc[1].src_plane);
          v114 = (uint8_t)plane_desc[1].src_plane;
          n5_6 = n5_9;
          ...
          *((uint32_t *)v50 + 52) += 2;
          *((uint32_t *)v50 + 53) += 2;
          v60 = *(uint8_t *)(a2 + (uint8_t)plane_desc[2].src_plane);
          v113 = (uint8_t)plane_desc[2].src_plane;
          if ( v109 )
            v60 = v60 - v105 - *(uint8_t *)((uint8_t)plane_desc[1].src_plane + a2);
          v61 = (Obj0 *)(v102);
          v118 = v60;
          ...
          *v61->f196 = v118;
          ...
          ((uint8_t**)v61)[v61->f12[2] + 6] = &((uint8_t**)v61)[v61->f12[2] + 6][v61->f196[1]
                                                           - *(v61->f196 - 7)
                                                           - (*(v61->f212 - 3)
                                                            - v61->f212[13])
                                                           - (*(v61->f204 - 3)
          ...
          v61->f208 += 2;
          v61->f212 += 2;
          v69 = *(uint8_t *)((uint8_t)plane_desc[3].src_plane + a2);
          v117 = (uint8_t)plane_desc[3].src_plane;
          if ( v108 )
            v69 = (uint8_t)(v69
                                  - v106
                                  - ((plane_desc[(uint8_t)plane_desc[3].src_plane + 1].w4
                                    * *(uint8_t *)((uint8_t)plane_desc[1].src_plane + a2)
                                    + plane_desc[(uint8_t)plane_desc[3].src_plane + 1].w8
                                    * (uint32_t)*(uint8_t *)((uint8_t)plane_desc[2].src_plane + a2)
                                    + 40) >> 7));
          v70 = (Obj0 *)(v103);
          ...
          *v70->f196 = v69;
          ...
          ((uint8_t**)v70)[v70->f12[2] + 6] = &((uint8_t**)v70)[v70->f12[2] + 6][v70->f196[1]
                                                           - *(v70->f196 - 7)
                                                           - (*(v70->f212 - 3)
                                                            - v70->f212[13])
                                                           - (*(v70->f204 - 3)
          ...
          if ( plane_count >= 4 )
          {
            ...
            *v80->f196 = v99;
            ...
            ((uint8_t**)v80)[v80->f12[2] + 6] = &((uint8_t**)v80)[v80->f12[2] + 6][v80->f196[1]
                                                             - *(v80->f196 - 7)
                                                             - (*(v80->f212 - 3)
                                                              - v80->f212[13])
                                                             - (*(v80->f204 - 3)
...
uint32_t __alt_p2_model(Obj11 *a1, const __m128 &a2__ref, int32_t a3, uint8_t a4, int32_t a5)
{
  int32_t n2;
  uint16_t *n0xF0;
  uint32_t n0x10_2;
...
void __alt_p2_d8_decode_body(Obj11 *lpAddress, char ArgList, const __m128 &a3__ref, const __m128 &a4__ref, uint8_t *a5, int32_t i, int32_t a7)
{
...
static inline void __fwd_alt_model_p2_d8_decode_alt_p2_d8_decode_body(int32_t a0, char a1, const __m128 &a2, const __m128 &a3, void *a4, int32_t a5, int32_t a6) { __alt_p2_d8_decode_body((Obj11 *)a0, a1, a2, a3, (uint8_t *)a4, a5, a6); }
...
int32_t __alt_model_p2_decode(uint16_t *p_i, uint8_t *Src)
{
  ...
  v163 = plane_desc[(uint8_t)plane_desc[2].src_plane + 1].flags & 8;
  v9 = plane_desc[(uint8_t)__n3_0 + 1].flags;
  ArgList = plane_desc[(uint8_t)plane_desc[3].src_plane + 1].flags & 8;
  v153 = v9 & 8;
  __rc_begin_decode(ArgList);
  if ( v5 > 0 )
  {
    ...
    do
    {
      ...
      if ( i > 0 )
      {
        ...
        do
        {
          ...
          __alt_p2_model((Obj11 *)lpAddress_1, __xmmword_439B60, v104, v103, v104 - v168);
          ...
          ctx_bias[3] += 32 * v108;
          v109 = v163 == 0;
          Src[(uint8_t)plane_desc[1].src_plane] = v104;
          if ( v109 )
            v110 = 0;
          else
            v110 = 16 * Src[(uint8_t)plane_desc[1].src_plane];
          v111 = (Obj11 *)(plane[1]);
          *(uint16_t *)(plane[1]->f278528[13].m128_i32[0] + 2) = v110;
          ...
          v169 = v114;
          __alt_p2_model((Obj11 *)v111, __xmmword_439B60, v114, v113, v114 - v112);
          ...
          ctx_bias[3] += 32 * v118;
          v109 = ArgList == 0;
          Src[(uint8_t)plane_desc[2].src_plane] = v169;
          if ( v109 )
            LOWORD(v119) = 0;
          else
            v119 = (plane_desc[(uint8_t)plane_desc[3].src_plane + 1].w8 * Src[(uint8_t)plane_desc[2].src_plane]
                  + plane_desc[(uint8_t)plane_desc[3].src_plane + 1].w4 * Src[(uint8_t)plane_desc[1].src_plane]) >> 3;
          v120 = (Obj11 *)(plane[2]);
          *(uint16_t *)(plane[2]->f278528[13].m128_i32[0] + 2) = v119;
          ...
          v170 = v123;
          __alt_p2_model((Obj11 *)v120, __xmmword_439B60, v123, v122, v123 - v121);
          ...
          ctx_bias[2] += 32 * v126;
          ctx_bias[3] += 32 * v127;
          Src[(uint8_t)plane_desc[3].src_plane] = v170;
          n4_1 = plane_count;
          if ( plane_count >= 4 )
          {
            if ( v153 )
            ...
            *(uint16_t *)(plane[3]->f278528[13].m128_i32[0] + 2) = v128;
            ...
            __alt_p2_model((Obj11 *)v129, __xmmword_439B60, v154, v131, v154 - v130);
      ...
      *(uint16_t *)(lpAddress->f278528[13].m128_i32[0] + 2) = 0;
      if ( i > 0 )
      {
        ...
        for ( k = 0; k < i; ++k )
        {
          ...
          __alt_p2_model((Obj11 *)lpAddress_1, a3, (uint8_t)v105[k], v110, (uint8_t)v105[k] - v95);
          v8 = &v109[k + 1];
...
int32_t __alt_model_p2_encode(BmfImage *p_i, uint8_t *a2)
{
  ...
  v169 = plane_desc[(uint8_t)plane_desc[2].src_plane + 1].flags & 8;
  v9 = plane_desc[(uint8_t)__n3_0 + 1].flags;
  v168 = plane_desc[(uint8_t)plane_desc[3].src_plane + 1].flags & 8;
  v155 = v9 & 8;
  __rc_begin_encode();
  if ( v5 > 0 )
  {
    ...
    do
    {
      ...
      else
      {
        ...
        for ( i = 0; i < i_2; ++i )
        {
          v184 = (uint8_t)plane_desc[1].src_plane;
          ctx_bias[0] = v102 >> 3;
          ctx_bias[1] = v101 >> 3;
          ctx_bias[2] = v100 >> 3;
          ctx_bias[3] = v99 >> 3;
          lpAddress_1 = (Obj11 *)(plane[0]);
          v104 = v166[(uint8_t)plane_desc[1].src_plane];
          ...
          __fwd_alt_model_p2_encode_alt_p2_encode_symbol(
            ...
            v105);
          __alt_p2_model((Obj11 *)lpAddress_1, __xmmword_439B50, v104, v105, v104 - v178);
          ...
          ctx_bias[3] += 32 * v112;
          if ( v169 )
            v113 = 16 * v166[(uint8_t)plane_desc[1].src_plane];
          else
            v113 = 0;
          v114 = (Obj11 *)(plane[1]);
          *(uint16_t *)(plane[1]->f278528[13].m128_i32[0] + 2) = v113;
          v176 = (uint8_t)plane_desc[2].src_plane;
          v115 = v166[(uint8_t)plane_desc[2].src_plane];
          ...
          __alt_p2_model((Obj11 *)v114, __xmmword_439B50, v115, v116, v115 - v179);
          ...
          ctx_bias[3] += 32 * v123;
          if ( v168 )
            v124 = (plane_desc[(uint8_t)plane_desc[3].src_plane + 1].w8 * v166[(uint8_t)plane_desc[2].src_plane]
                  + plane_desc[(uint8_t)plane_desc[3].src_plane + 1].w4 * v166[(uint8_t)plane_desc[1].src_plane]) >> 3;
          else
            LOWORD(v124) = 0;
          v125 = (Obj11 *)(plane[2]);
          *(uint16_t *)(plane[2]->f278528[13].m128_i32[0] + 2) = v124;
          v177 = (uint8_t)plane_desc[3].src_plane;
          v126 = v166[(uint8_t)plane_desc[3].src_plane];
          ...
          __alt_p2_model((Obj11 *)v125, __xmmword_439B50, v126, v127, v126 - v180);
          ...
          if ( plane_count >= 4 )
          {
            ...
            *(uint16_t *)(plane[3]->f278528[13].m128_i32[0] + 2) = v132;
            ...
            __alt_p2_model((Obj11 *)v133, __xmmword_439B50, v134, v135, v134 - v157);
  ...
  if ( (v92 & 8) != 0 )
  {
    *(uint32_t *)p_i = *(uint32_t *)&p_i_1->width;
    ...
    if ( ::plane_count > 0 )
    {
      ...
      do
      {
        v33 = (uint8_t)plane_desc[ArgList + 1].src_plane;
  ...
  // always taken: -Q is 9
  {
    ...
    *((uint16_t *)Blockb_7 + 2) = v115;
    ...
    if ( ::plane_count > 0 )
    {
      ...
      while ( 1 )
      {
        v119 = (uint8_t)plane_desc[v118 + 1].src_plane;
        v178[0] = (char *)v119;
...
LABEL_22:
  ...
  if ( ::plane_count > 0 )
  {
    ...
    do
    {
      v25 = (4 * (uint8_t)plane_desc[n4 + 1].flags) | (uint8_t)plane_desc[n4 + 1].predictor;
      if ( bits_left < 6 )
      {
      ...
      if ( (plane_desc[n4 + 1].flags & 8) != 0 )
      {
        ...
        ::packer_free_bits = bits_left;
        if ( (uint8_t)plane_desc[n4 + 1].predictor > 1u )
        {
          ...
          ::packer_free_bits = bits_left;
          if ( (uint8_t)plane_desc[n4 + 1].predictor > 2u )
          {
  ...
  if ( ElementCount )
  {
    ...
    if ( ::plane_count > 0 )
    {
      ...
      n4_1 = 0;
      do
        __fwd_compress_image_model_planes((char *)p_i, Srca, (uint8_t)plane_desc[n4_1++ + 1].src_plane, v36, a2, a3);
      while ( n4_1 < ::plane_count );
      v5 = v66;
    }
    free(Srca);
