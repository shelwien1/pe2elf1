...
int32_t __pixel_context(ModelBlock *_this, uint32_t *p_n15)
{
  ...
  *(int32_t *)&_this->f52 = v6;
  if ( (v4 + v3 == 0) && n6 > 6 )
    return -1;
  v7 = _this->sel0_list;
  v9 = v6 + 8 * sym_in_top((v7[mode_symbol[1]].ent), 10, result);
  *(int32_t *)&_this->f52 = v9;
  v10 = v7[mode_symbol[2]].ent;
  v11 = v7[result].ent;
  v13 = sym_in_top((v7[mode_symbol[3]].ent), 6, result)
...
int32_t __alt_p1_context(AltP1Block *_this, AltP1Block *a2, AltP1Block *a3)
{
  ...
  if ( a2 )
  {
    if ( a3 )
    {
      ...
      _this->ctx_w[7].sel = (v34[-1].sym
                                       ...
                                       + a3->cursor[0][-1].sym
                                       - a3->cursor[0][-2].sym);
      _this->ctx_w[8].sel = (a3->cursor[0][-1].sym - a3->f8);
      _this->ctx_w[3].sel = (a2->cursor[0][-1].sym - a2->f8);
      v37 = (a3->cursor[0][-1].mag + (uint32_t)a2->cursor[0][-1].mag - 16) >> 31;
    }
    else
    {
      v36 = v3[3].mag + v11 + 3 * a2->cursor[0][-1].mag;
      _this->ctx_w[5].sel = (2 * v5[-1].sym - v5[-2].sym - (uint32_t)v4);
      _this->ctx_w[6].sel = (2 * v5[-1].sym - v5[-2].sym - (uint32_t)v4);
      _this->ctx_w[7].sel = (-v4 - v3->sym + v3[1].sym + v5[-1].sym);
  ...
  {
    v32 = _this->cursor[4];
    v36 = v32->mag + v33[-2].mag + v3[3].mag + v11 + v32[2].mag;
    _this->ctx_w[5].sel = (2 * v5[-1].sym - v5[-2].sym - (uint32_t)v4);
    _this->ctx_w[6].sel = (2 * v3->sym - v33->sym - (uint32_t)v4);
    _this->ctx_w[7].sel = (-v4 - v3->sym + v3[1].sym + v5[-1].sym);
    _this->ctx_w[8].sel = (-3 * (v5[-2].sym - v5[-1].sym)
                                     + v5[-3].sym
                                     - (uint32_t)v4);
    _this->ctx_w[3].sel = (v3[2].sym - (uint32_t)v4);
    v37 = v5->mag + v32->mag + _this->cursor[3]->mag + v33->mag + v3->mag == 0;
  }
  v16 = (v36 + 7) >> 4;
  v17 = _this->f216[v16];
  ...
  v18 = (v3[-1].sym - v3->sym >= 0) + (v3[-1].sym > (int32_t)v3->sym);
  _this->ctx_w[1].sel = v18;
  v39 = (v3[-1].sym - v5[-1].sym >= 0) + (v3[-1].sym > (int32_t)v5[-1].sym);
  _this->ctx_w[2].sel = v39;
  v19 = _this->ctx_w[3].sel == 0;
  v20 = _this->ctx_w[3].sel < 0;
  v40 = (v3[1].sym - v4 >= -v35) + (v3[1].sym - v4 > v35);
...
int32_t __alt_p1_model(AltP1Block *_this)
{
  ...
  n5 = *((uint8_t)(_this->cursor[0]->sym - (uint8_t)_this->f8) + _this->fold);
  v3 = _this->ctx_w[1].sel;
  n5_1 = *((uint8_t)((uint8_t)_this->f8 - _this->cursor[0]->sym) + _this->fold);
  v5 = _this->ctx_w[2].sel;
  n2 = (int32_t)(n5 - 5) >> 1;
  n5_2 = 6 - (n5 & 1);
  if ( n5 < 5 )
    n5_2 = *((uint8_t)(_this->cursor[0]->sym - (uint8_t)_this->f8) + _this->fold);
  n5_3 = 6 - (n5_1 & 1);
  if ( n5_1 < 5 )
    n5_3 = n5_1;
  n5_4 = n5_3;
  ...
  if ( _this->counters[result].total < 0xCCCu )
  {
    ...
    else
    {
      ...
      v27 = &_this->counters[(v24 + _this->f12[0] - _this->ctx_w[1].w[_this->ctx_w[1].sel])];
      v27[0].c[n5_2] += 6;
      v27[0].total += 6;
...
int32_t *__alt_p1_alloc(AltP1Block *_this, int32_t i, int32_t a3, int32_t n4) {   P1Ctx *v22;
  ...
  do
    _this->buf[n5++] = (P1Ctx *)bmf_new(2 * _this->f0 + 20);
  while ( n5 < 5 );
...
{
  P1Ctx *v10, *v11, *v27, *v5, *v6, *v7, *v8, *v9;
  ;
  uint8_t v33, v35;
  ...
  if ( _this->f4 > 0 )
  {
    ...
    do
    {
      ...
      v30 = v27[-3].mag + v28;
      _this->f12[4] = v30;
      _this->f12[3] = v27[-2].mag + v29;
      _this->f12[4] = v27[-1].mag + v30;
      if ( !(_this->f0 <= 0) )
      {
        v32 = a3;
        v40 = v4;
...
void ** __alt_model_p1_d8_decode(int8_t ArgList, uint8_t *Src, int32_t i, int32_t a4)
{
  ...
  if ( v5->f4 > 0 )
  {
    ...
    do
    {
      ...
      v32 = v29[-3].mag + v30;
      v5->f12[4] = v32;
      v5->f12[3] = v29[-2].mag + v31;
      v5->f12[4] = v29[-1].mag + v32;
      if ( !(v5->f0 <= 0) )
      {
        Src_1 = Src;
        v39 = v6;
    ...
    do
    {
      if ( n4_1 > 0 )
      {
        ...
        do
        {
          ...
          v50 = v47[-3].mag + v48;
          v24->f12[4] = v50;
          v24->f12[3] = v47[-2].mag + v49;
          v24->f12[4] = v47[-1].mag + v50;
          n4_1 = plane_count;
        }
      ...
      if ( i_3 > 0 )
      {
        ...
        do
        {
          ...
          *(Src + plane_desc[2].src_plane) = v104;
          ...
          ((uint8_t**)v66)[v66->f12[2] + 6] = &((uint8_t**)v66)[v66->f12[2] + 6][v66->cursor[0]->mag
                                                           - v66->cursor[0][-4].mag
                                                           - (v66->cursor[4][-2].mag
                                                            - v66->cursor[4][6].mag)
                                                           - (v66->cursor[2][-2].mag
          ...
          if ( plane_count >= 4 )
          {
            ...
            ((uint8_t**)v73)[v73->f12[2] + 6] = &((uint8_t**)v73)[v73->f12[2] + 6][v73->cursor[0]->mag
                                                             - v73->cursor[0][-4].mag
                                                             - (v73->cursor[4][-2].mag
                                                              - v73->cursor[4][6].mag)
                                                             - (v73->cursor[2][-2].mag
...
int32_t __alt_p2_context(AltP2Block *a1, AltP2Block *a4, AltP2Block *a5) {   P2Ctx *v55,
  ...
  P2Ctx *v7, *v45, *v67;
  int32_t *v104;
  int32_t v12, v13, v14, v15, v16, v17, v18, v19, v21, v25, v29, v30, v65,
...
int32_t __choose_plane_coding(BmfImage *a1, int32_t n3, int8_t a3)
{
  ...
  int16_t v92;
  int32_t n4, v6, n192, v11, v13, v14, n2_3, n2, n16, *v25, n128_1, n128, v30,
...
int32_t __decode_symbol_list(SymList *a1)
{
  ...
  // The cumulative count the range coder takes, which it takes unsigned.
  uint32_t n0x2000_2;
  int32_t sym_cum, sym_high, v2, v5, v6, v8, n251, v46, v49, v53;
...
int32_t __decode_pixel(ModelBlock *_this, int32_t a2)
{
  ...
  int32_t n4_8, n4_7, n15_6, n15_7, v8, v9, v12, v13, v15, n4_9,
          __decode_pixel_n15, v22, n4_11, v26, v27, v29, v31, n0xFFFF, v33,
          ...
          v143, n4_18, n15_19, n15_20, v148, v149, v150, v151, v152, v153,
...
int32_t __code_pixel(ModelBlock *_this, int32_t a2)
{
  ...
  // range coder takes, and it takes them unsigned.
  uint32_t arg_cum, arg_high, arg_tot;
  int32_t n4, n4_1, __code_pixel_n15, n15_1, v10, v13, v15, n15_6, n15_5,
          n15_8, v21, p_n15_1, n15_30, v26, v27, v29, n0xFFFF, v32, n0xFFFF_1,
          n53248, v35, v38, v39, v42, p_n15_2, n15_42, run, v46, n15_32,
          n15_12, n15_9, v50, v53, p_n15_4, n2_10, v61, n15_11, n15_13, n4_2,
          ...
          p_n15_6, *v143, v144, n2_16, n2_17, n15_37, v149, v150, v151, v152,
...
void __unmodel_plane_slow(ModelBlock *_this, uint8_t *Src)
{
  ...
  int32_t v5, v6, v8, n5, v14, v15, v16, v17, v18, n0x10000, v30, v34, v39,
          v40, n4_1, v43, v51, v52, v53, v54, v56, v58, v60, v61, v62, v64,
          v65, v66, n6, v68, v69, n6_4, n6_1, v73, n6_2, v76, v78, v80;
  ModelBlock *this_3;
  ModelBlock *this_2;
  uint32_t *ArgList_6;
    ...
    do
    {
      if ( n4_1 > 0 )
      {
        ...
        do
        {
          ...
          v49 = v46[-3].mag + v47;
          v23->f12[4] = v49;
          v23->f12[3] = v46[-2].mag + v48;
          v23->f12[4] = v46[-1].mag + v49;
          n4_1 = plane_count;
        }
        while ( n4_2 < plane_count );
        v19 = __frame.v91;
      ...
      if ( i_3 > 0 )
      {
        ...
        do
        {
          ...
          ((uint8_t**)v61)[v61->f12[2] + 6] = &((uint8_t**)v61)[v61->f12[2] + 6][v61->cursor[0]->mag
                                                           - v61->cursor[0][-4].mag
                                                           - (v61->cursor[4][-2].mag
                                                            - v61->cursor[4][6].mag)
                                                           - (v61->cursor[2][-2].mag
          ...
          ((uint8_t**)v70)[v70->f12[2] + 6] = &((uint8_t**)v70)[v70->f12[2] + 6][v70->cursor[0]->mag
                                                           - v70->cursor[0][-4].mag
                                                           - (v70->cursor[4][-2].mag
                                                            - v70->cursor[4][6].mag)
                                                           - (v70->cursor[2][-2].mag
          ...
          if ( plane_count >= 4 )
          {
            ...
            ((uint8_t**)v80)[v80->f12[2] + 6] = &((uint8_t**)v80)[v80->f12[2] + 6][v80->cursor[0]->mag
                                                             - v80->cursor[0][-4].mag
                                                             - (v80->cursor[4][-2].mag
                                                              - v80->cursor[4][6].mag)
                                                             - (v80->cursor[2][-2].mag
...
int32_t __alt_model_p2_decode(uint16_t *p_i, uint8_t *Src) {   P2Ctx *v105,
        *v115, *v124, *v132, *v30, *v34, *v38, *v67, *v75, *v81, *v82, *v83,
        *v84, *v85, *v86, *v88, *v90, *v92, *v94, *v96, *v98;
...
int32_t __alt_model_p2_encode(BmfImage *p_i, uint8_t *a2) {   P2Ctx *v109,
        *v120, *v131, *v139, *v29, *v33, *v37, *v66, *v74, *v80, *v81, *v82,
        *v83, *v84, *v85, *v87, *v89, *v91, *v93, *v95, *v97;
  int32_t v155;
  int32_t n3;
  int32_t v157;
  int32_t v158;
  ...
  bool v16;
  int16_t v113;
  int32_t i_1, v5, n4, n4_1, v14, v15, v30, v99, v57, *v58, v100, v101, v102,
