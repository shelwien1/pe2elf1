...
rem
rem Context model (see the header of coder0.cpp): the default is the Tangelo
...
rem ---------------------------------------------------------------------------
set tfdefs=-DTF_TRAIN=3 -DTF_FP32=1
set tfdefs=-DTF_TRAIN=0 -DTF_FP32=0 -DUSE_PPMD=0
