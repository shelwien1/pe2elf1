...
%gcc% -s -std=c++23 -Ofast -O3 -fpermissive -Wno-format %arch% %incs% %opts% %defs% -static -shared -D_USE_MATH_DEFINES oggcomp_dll.cpp -o oggcomp1.dll
